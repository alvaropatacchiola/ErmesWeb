Public Class manual_lds
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            save_manual_newlds.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                        ClientScript.GetPostBackEventReference(save_manual_newlds, ""))
            ...
            Literal3.Text = label_canale2_temp + " " + GetGlobalResourceObject("ld_global", "pulse") + "1"
            Label7.Text = label_canale2_temp + " " + GetGlobalResourceObject("ld_global", "relay") + "1"

            Literal14.Text = label_canale2_temp + " " + GetGlobalResourceObject("ld_global", "pulse") + "2"
            Literal10.Text = label_canale2_temp + " " + GetGlobalResourceObject("ld_global", "relay") + "2"
    ...
    Private Function MakeManual() As String
        ...
        If check_relay2_id.Checked Then
            ...
            string_connect = "05" + Format(Val(value_relay2_id.Text), "00")
        End If
    ...
    Protected Sub save_manual_newlds_Click(sender As Object, e As EventArgs) Handles save_manual_newlds.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=24" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
