<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="logsetup_ltb.aspx.vb" Inherits="ermes_web_20.logsetup_ltb" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="ltb/logsetup_ltb.aspx">
    ...
    <div class="innerLR">
        <div class="box-generic">
			...
			<div class="tab-pane active" id="tab_ld_sp1_1">
                ...
                <div class="row-fluid">
               	<div class="span12">
              <h5 style="padding-top:10px"><asp:literal ID = "Label7"  text="Log LTB" runat="server" meta:resourcekey="Label7Resource1"></asp:literal></h5>
...
<!-- tab 1 stop-->
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_logsetupltb_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_logsetupltb_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
    <script type="text/javascript" src="ltb/validator_ltb_logsetup.js"></script>
