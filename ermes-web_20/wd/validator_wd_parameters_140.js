...
$("#save_parameters_wd_140_new").click(function () {
    ...
    $('#save_parameters_wd_140_new').next('p').remove();
    ...
    if ((validator_password_old == false) || (validator_password == false)) {
        ...
        $('#save_parameters_wd_140_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + ' </span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
