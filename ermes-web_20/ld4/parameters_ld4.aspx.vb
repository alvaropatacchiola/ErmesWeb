Public Class parameters_ld4
    ...
    Private Sub parameters_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_parameters_ld4(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "probe_failure"))
        End If
    End Sub
    Public Sub posiziona_parameters_ld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_parameters_new_ld4.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_parameters_new_ld4, ""))
    ...
    Protected Sub save_parameters_new_ld4_Click(sender As Object, e As EventArgs) Handles save_parameters_new_ld4.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=35" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
