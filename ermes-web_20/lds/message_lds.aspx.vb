Public Class message_lds
    ...
    Private Sub message_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_messagelds(nome_impianto, codice_impianto, id_485_impianto)

        End If

    End Sub
    Public Sub posiziona_messagelds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String)
        ...
        save_message_newlds.OnClientClick = String.Format("salva_dati(""{0}""); return false;",
                    ClientScript.GetPostBackEventReference(save_message_newlds, ""))
    ...
    Protected Sub save_message_newlds_Click(sender As Object, e As EventArgs) Handles save_message_newlds.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=25" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
