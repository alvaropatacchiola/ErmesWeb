Public Class dosing_alarms
    ...
    Private Sub dosing_alarms_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
       Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_dosing_lds(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "dosing_alarm"))
        End If
    End Sub
    Public Sub posiziona_dosing_lds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_alarmdosinglds_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_alarmdosinglds_new, ""))
        ...
        dosing_modecl = Mid(dosing_value(1), 1, 1)
        dosing_timecl = Mid(dosing_value(2), 1, 3)
    ...
    Private Function MakeDosString() As String
        ...
        If cl_alarm_dosing_disable.Checked = True Then 'off
            app_time_ph = "000"
        Else
            app_time_ph = Format(Val(value_cl_alarm_dosing.Text), "000")
        End If
    ...
    End Function
    Protected Sub save_alarmdosinglds_new_Click(sender As Object, e As EventArgs) Handles save_alarmdosinglds_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=15" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
