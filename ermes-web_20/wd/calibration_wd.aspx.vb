Public Class calibration_wd
    ...
    Private Sub calibration_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_calibrationwd(nome_impianto, codice_impianto, id_485_impianto, GetGlobalResourceObject("ld_global", "val_calibration"), GetGlobalResourceObject("ld_global", "val_canale"), GetGlobalResourceObject("ld_global", "val_mvprobe"), GetGlobalResourceObject("ld_global", "val_valueprobe"), GetGlobalResourceObject("ld_global", "val_valuenew"))

        End If
    End Sub
    Public Sub posiziona_calibrationwd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
        ...
        save_calibration_newwd.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_calibration_newwd, ""))
        ...
        label_canale_temp = main_function_config.get_tipo_strumento_ld_lds_wd(calibrz_value(1), fattore_divisione_temp, full_scale_temp, , "")
        ...
        label_canale2_temp = main_function_config.get_tipo_strumento_ld_lds_wd(calibrz_value(2), fattore_divisione_temp2, full_scale_temp2, , "")
    ...
    Protected Sub save_calibration_newwd_Click(sender As Object, e As EventArgs) Handles save_calibration_newwd.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=18" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
