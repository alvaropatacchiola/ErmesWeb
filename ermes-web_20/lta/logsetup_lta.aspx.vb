Public Class logsetup_lta
    ...
    Private Sub log_setup_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_log_lta(nome_impianto, codice_impianto, id_485_impianto, canale)
        End If
    End Sub
    Public Sub posiziona_log_lta(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        save_logsetuplta_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_logsetuplta_new, ""))
    ...
    Protected Sub save_logsetuplta_new_Click(sender As Object, e As EventArgs) Handles save_logsetuplta_new.Click
        ...
        Response.Redirect("~/lta.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=5" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
