<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="unit.aspx.vb" Inherits="ermes_web_20.unit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="tower/unit.aspx">
    <h3><asp:literal runat="server" text ="Unit Tower" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- tab 1 stop-->
                <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_unittower_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Save and Load Data" Font-Bold="True" meta:resourcekey="save_flowtower_newResource1" /><i></i></b>
                </div>
                </div>
            <script type="text/javascript" src="tower/validator_tower_unit.js"></script>
