<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Probe_Failure_wd.aspx.vb" Inherits="ermes_web_20.WebForm3" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="wd/Probe_Failure_wd.aspx">
...
<div id ="enable_value_cl_alarm_failure">
                <div class="row-fluid">
               	<div class="span3">
                       ...
                       <asp:textbox ID="value_cl_alarm_failure" onblur="javascript: Changed_channel( 'value_cl_alarm_failure','riga1_cl_alarm_failure',999,0,0 );" class="span12"  runat="server" MaxLength="3" meta:resourcekey="value_cl_alarm_failureResource1" Columns="3" ></asp:textbox>
                </div>
                       </div>
...
<!-- tab 2 stop-->  
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_probefailurewd_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_probefailurewd_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
                <script type="text/javascript" src="wd/validator_wd_probe_failure.js"></script>
