<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="bleed.aspx.vb" Inherits="ermes_web_20.bleed" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server"  method="post" action="tower/bleed.aspx">
    <h3><asp:literal runat="server" text ="Bleed Tower" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- riga -->
                ...
                <div class="row-fluid">
               	<div class="span2">
                       ...
                       <asp:textbox ID="value_bleed_setpoint" onblur="javascript: Changed_channel( 'value_bleed_setpoint','riga_bleed_setpoint',max_us, 0,0 );" class="span12"  runat="server" MaxLength="5" meta:resourcekey="value_bleed_setpointResource1" ></asp:textbox>
                </div>
                       </div>
 	<div class="span2">
                ...
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_bleed_delay_hr" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal5"  text="Delay (Hour)" runat="server" meta:resourcekey="Literal5Resource1"></asp:literal></h5>
                       <asp:textbox ID="value_bleed_delay_hr" onblur="javascript: Changed_channel( 'value_bleed_delay_hr','riga_bleed_delay_hr',99, 0,0 );" class="span12"  runat="server" MaxLength="2" meta:resourcekey="value_bleed_delay_hrResource1" ></asp:textbox>
                </div>
                       </div>
 	<div class="span2">
...
<!-- tab 1 stop-->
                <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_bleedtower_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_bleedtower_newResource1" /><i></i></b>
                </div>
                </div>
            <script type="text/javascript" src="tower/validator_tower_bleed.js"></script>
