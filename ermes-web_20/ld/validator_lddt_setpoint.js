...
var temp_relay_on = false;
var temp_relay_pm1 = false;
var temp_relay_off = false;
var temp_relay_pm2 = false;
...
function Changed_channel(id1, id2, max_ch, min_ch, myfix) {
    ...
    switch (id1) {
        ...
        case "value1_temp_relay_1":
            
            temp_relay_on = var_alarm;
            check_alarm_channel_temp_relay();
            break;
        case "value2_temp_relay_1":
            //ph_relay_pm1 = var_alarm;
            //check_alarm_channel_ph_relay();

            
            var myNumber2;
            var value_form2 = $(value2_temp_relay_2).val();

            if (($('#fixed_temp_relay').is(':checked'))) {

                temp_relay_pm1 = var_alarm;

                temp_relay_pm1 = false;
                temp_relay_pm2 = false;
            ...
            if (!($('#fixed_temp_relay').is(':checked'))) {
                ...
                else temp_relay_pm1 = false;
                //ph_relay_pm1 = false;

            }
            break;

        case "value1_temp_relay_2":
       
            temp_relay_off = var_alarm;
            check_alarm_channel_temp_relay();
            break;
        case "value2_temp_relay_2":
            //ph_relay_pm2 = var_alarm;
            //check_alarm_channel_ph_relay();

            var myNumber2;
            var value_form2 = $(value2_temp_relay_1).val();

            if (($('#fixed_temp_relay').is(':checked'))) {

                temp_relay_pm2 = var_alarm;
                temp_relay_pm1 = false;
                temp_relay_pm2 = false;
...
function check_alarm_channel_temp_relay() {

    if ((temp_relay_on == true) || (temp_relay_pm1 == true) || (temp_relay_off == true) || (temp_relay_pm2 == true)) {
...
//temp relay
$("#value1_temp_relay_1").keypress(function (evt) {
    return keypress_channel(evt);
});
$("#value2_temp_relay_1").keypress(function (evt) {
    return keypress_perc(evt);
});

$("#value1_temp_relay_2").keypress(function (evt) {
    return keypress_channel(evt);
});
$("#value2_temp_relay_2").keypress(function (evt) {
    return keypress_perc(evt);
});
...
//temp relay
function disable_channel_temp_relay() {
    temp_relay_on = false;
    temp_relay_pm1 = false;
    temp_relay_off = false;
    temp_relay_pm2 = false;
    check_alarm_channel_temp_relay();
    remove_allarme('value1_temp_relay_1', 'riga1_temp_relay_1');
    remove_allarme('value2_temp_relay_1', 'riga2_temp_relay_1');
    remove_allarme('value1_temp_relay_2', 'riga1_temp_relay_2');
    remove_allarme('value2_temp_relay_2', 'riga2_temp_relay_2');

    $("#disable_temp_relay").hide();
}
...
//temp relay
function enable_channel_temp_relay_on_off() {
    ...
    remove_allarme('value2_temp_relay_1', 'riga2_temp_relay_1');
    remove_allarme('value2_temp_relay_2', 'riga2_temp_relay_2');
    $("#disable_temp_relay").show();

    $("#label1_temp_relay_else").hide();
    $("#label1_temp_relay_on_off").show();
    $("#riga2_temp_relay_1").hide();

    $("#label2_temp_relay_else").hide();
    $("#label2_temp_relay_on_off").show();
    $("#riga2_temp_relay_2").hide();
}
...
//temp relay
function enable_channel_temp_relay_proportionalpwm() {

    check_alarm_channel_temp_relay();
    $("#disable_temp_relay").show();

    $("#riga2_temp_relay_1").show();
    $("#riga2_temp_relay_2").show();

    $("#label1_temp_relay_on_off").hide();
    $("#label1_temp_relay_else").show();
    $("#label1_temp_relay_proportionalpwm").show();
    $("#label1_temp_relay_fixedpwm").hide();

    $("#label2_temp_relay_on_off").hide();
    $("#label2_temp_relay_else").show();
    $("#label2_temp_relay_proportionalpwm").show();
    $("#label2_temp_relay_fixedpwm").hide();


}


function enable_channel_temp_relay_fixedpwm() {
    ...
    $("#label1_temp_relay_on_off").show();
    $("#label1_temp_relay_else").hide();
    $("#label1_temp_relay_proportionalpwm").hide();
    $("#label1_temp_relay_fixedpwm").show();

    $("#label2_temp_relay_on_off").show();
    $("#label2_temp_relay_else").hide();
    $("#label2_temp_relay_proportionalpwm").hide();
    $("#label2_temp_relay_fixedpwm").show();
...
//temp relay
$("#on_off_temp_relay").click(function () {
    enable_channel_temp_relay_on_off();

});
$("#proportional_temp_relay").click(function () {

    enable_channel_temp_relay_proportionalpwm();
});
$("#fixed_temp_relay").click(function () {
    enable_channel_temp_relay_fixedpwm();
});
$("#off_temp_relay").click(function () {
    disable_channel_temp_relay();
});
...
$("#tab_ld_sp7").click(function () {
    if ($('#on_off_temp_relay').is(':checked')) {
        enable_channel_temp_relay_on_off();
    }
    if ($('#proportional_temp_relay').is(':checked')) {
        enable_channel_temp_relay_proportionalpwm();
    }
    if ($('#fixed_temp_relay').is(':checked')) {
        enable_channel_temp_relay_fixedpwm();
    }
    if ($('#off_temp_relay').is(':checked')) {
        disable_channel_temp_relay();
    }
});
...
// temp relay
$("#value1_temp_relay_1").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga1_temp_relay_1").removeClass('error');
    temp_relay_on = false;
    check_alarm_channel_temp_relay();
    // $("#principale").load("test.aspx");
});
$("#value2_temp_relay_1").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga2_temp_relay_1").removeClass('error');
    temp_relay_pm1 = false;
    check_alarm_channel_temp_relay();
    // $("#principale").load("test.aspx");
});

$("#value1_temp_relay_2").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga1_temp_relay_2").removeClass('error');
    temp_relay_off = false;
    check_alarm_channel_temp_relay();
    // $("#principale").load("test.aspx");
});
$("#value2_temp_relay_2").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga2_temp_relay_2").removeClass('error');
    temp_relay_pm2 = false;
    check_alarm_channel_temp_relay();
    // $("#principale").load("test.aspx");
});
...
$("#save_setpointlddt_new").click(function () {
    ...
    if (!($('#off_temp_relay').is(':checked'))) {
        Changed_channel('value1_temp_relay_1', 'riga1_temp_relay_1', max_temp_value, min_temp_value, max_fix_temp);
        Changed_channel('value2_temp_relay_1', 'riga2_temp_relay_1', 100, 0, 0);
        Changed_channel('value1_temp_relay_2', 'riga1_temp_relay_2', max_temp_value, min_temp_value, max_fix_temp);
        Changed_channel('value2_temp_relay_2', 'riga2_temp_relay_2', 100, 0, 0);
    }
    ...
    if ((ph_pulse1_on) || (ph_pulse1_pm1) || (ph_pulse1_off) || (ph_pulse1_pm2) ||
           ...
           (ph_relay_pm2) || (temp_relay_on) || (temp_relay_off) ||
           (temp_relay_pm2) || (cl_pulse1_pm1) || (cl_pulse1_off) || (cl_pulse1_pm2) ||
           (cl_pulse1_speed) || (cl_relay_on) || (cl_relay_pm1) || (cl_relay_off) ||
           (cl_relay_pm2)) {
        $('#save_setpointlddt_new').next('p').remove();

        $('#save_setpointlddt_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
