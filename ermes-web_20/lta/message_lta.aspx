<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message_lta.aspx.vb" Inherits="ermes_web_20.message_lta" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="lta/message_lta.aspx">
    <h3><asp:literal runat="server" text ="Message LTA" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- tab 2 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_message_newlta" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_message_newltaResource1" /><i></i></b>
                </div>


            </div>
        </div>
    <script type="text/javascript" src="lta/validator_lta_message.js"></script>
