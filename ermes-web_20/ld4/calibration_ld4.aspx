<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calibration_ld4.aspx.vb" Inherits="ermes_web_20.calibration_ld4" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="ld4/calibration_ld4.aspx">
 ...
 <!-- fine riga -->
                ...
                <div id ="div_ch3" class="row-fluid">
               	<div class="span2">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal5"  text="Channel" runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
                    
                    <asp:literal ID="ch3_probe_enale_l" runat="server" text ="mV" meta:resourcekey="ch3_probe_enale_lResource1"></asp:literal>
                </div>
                    <div class="span2">
                        <h5 style="padding-top:10px"><asp:literal ID = "Literal10"  text="mV Probe" runat="server" meta:resourcekey="Literal6Resource1"></asp:literal></h5>
                        <div class="row-fluid">
                        <asp:literal ID = "ch3_probe_mv_value"  text="125" runat="server" meta:resourcekey="ch3_probe_mv_valueResource1"></asp:literal>
                            </div>
                        </div>
                    <div class="span2">
                        <h5 style="padding-top:10px"><asp:literal ID = "Literal12"  text="Probe Value" runat="server" meta:resourcekey="Literal7Resource1"></asp:literal></h5>
                        <div class="row-fluid">
                ...
                <h5 style="padding-top:10px" class="control-label"><asp:literal ID = "Literal14"  text="New Value" runat="server" meta:resourcekey="Literal8Resource1"></asp:literal></h5>
                <div class="row-fluid">
 ...
 <!-- fine riga -->
                ...
                <div id ="div_ch4" class="row-fluid">
               	<div class="span2">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal15"  text="Channel" runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
                    
                    <asp:literal ID="ch4_probe_enale_l" runat="server" text ="mV" meta:resourcekey="ch4_probe_enale_lResource1"></asp:literal>
                </div>
                    <div class="span2">
                        <h5 style="padding-top:10px"><asp:literal ID = "Literal17"  text="mV Probe" runat="server" meta:resourcekey="Literal6Resource1"></asp:literal></h5>
                        <div class="row-fluid">
                        <asp:literal ID = "ch4_probe_mv_value"  text="125" runat="server" meta:resourcekey="ch4_probe_mv_valueResource1"></asp:literal>
                            </div>
                        </div>
                    <div class="span2">
                        <h5 style="padding-top:10px"><asp:literal ID = "Literal19"  text="Probe Value" runat="server" meta:resourcekey="Literal7Resource1"></asp:literal></h5>
                        <div class="row-fluid">
                ...
                <h5 style="padding-top:10px" class="control-label"><asp:literal ID = "Literal21"  text="New Value" runat="server" meta:resourcekey="Literal8Resource1"></asp:literal></h5>
                <div class="row-fluid">
 ...
 <!-- fine riga -->                                    
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_calibration_newld4" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_temperature_newldResource1" /><i></i></b>
                </div>

            </div>
        </div>
    <script type="text/javascript" src="ld4/validator_ld4_calibration.js"></script>
