Public Class WebForm1
    ...
    Public Sub posiziona_setpoint_wd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_setpointwd_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_setpointwd_new, ""))
        ...
        If Mid(calibrz_value(3), 1, 2) = "03" Then
            ' solo in caso di WHPHRH PER
            setting_label_setpoint(etichetta_setpoint, " ", GetGlobalResourceObject("ld_global", "relay"), GetGlobalResourceObject("wd_global", "pulseminute"), GetLocalResourceObject("Literal10Resource1.Text"), Label7, Literal4, Literal6, Literal7, Literal7, Literal8, Literal10, Literal10, label_canale_temp)
            ' setting_label_setpoint(etichetta_setpoint, "2", "Pulse", "Pulse / Minute", "Pulse Speed", Literal8, Literal12, Literal13, Literal14, Literal15, Literal16, Literal17, Literal18)
            setting_label_setpoint(etichetta_setpoint2, "", GetGlobalResourceObject("ld_global", "relay"), GetGlobalResourceObject("wd_global", "pulseminute"), GetLocalResourceObject("Literal10Resource1.Text"), Literal35, Literal39, Literal40, Literal41, Literal42, Literal43, Literal44, Literal45, label_canale2_temp)
        ...
        Else
            ...
            ' setting_label_setpoint(etichetta_setpoint, "2", "Pulse", "Pulse / Minute", "Pulse Speed", Literal8, Literal12, Literal13, Literal14, Literal15, Literal16, Literal17, Literal18)
            setting_label_setpoint(etichetta_setpoint2, "", GetGlobalResourceObject("ld_global", "pulse"), GetGlobalResourceObject("wd_global", "pulseminute"), GetLocalResourceObject("Literal10Resource1.Text"), Literal35, Literal39, Literal40, Literal41, Literal42, Literal43, Literal44, Literal45, label_canale2_temp)
        ...
        'setting_label_setpoint_relay(etichetta_setpoint, "Relay", Literal9, Literal21, Literal22, Literal23, Literal24, Literal25, Literal26, Literal27, Literal28)
        'setting_label_setpoint_relay(etichetta_setpoint2, "Relay", Literal11, Literal38, Literal39, Literal40, Literal41, Literal42, Literal43, Literal44, Literal45)
    ...
    '                                   ByVal Literal4_1 As Literal, ByVal Literal5 As Literal, ByVal Literal5_1 As Literal)
    ...
    Protected Sub save_setpointwd_new_Click(sender As Object, e As EventArgs) Handles save_setpointwd_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=10" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
