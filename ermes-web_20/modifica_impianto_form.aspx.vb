Public Class modifica_setpoint_form
    Inherits lingua

    Public Shared utilizzatoreListTemp As DropDownList = New DropDownList


    Private Sub modifica_setpoint_form_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        save_modifica_impianto_new.OnClientClick = String.Format("salva_dati(""{0}""); return false",
                    ClientScript.GetPostBackEventReference(save_modifica_impianto_new, "pippo"))
    ...
    Private Sub save_modifica_impianto_new_Click(sender As Object, e As EventArgs) Handles save_modifica_impianto_new.Click
        ...
        If result_query Then ' salvataggio avvenuto con successo
            ...
            Response.Redirect("modifica_impianto_form.aspx?result=1&niente=0&codice=" + inputCodice.Text)
        Else
            Response.Redirect("modifica_impianto_form.aspx?result=2&niente=0&codice=" + inputCodice.Text)
        End If
