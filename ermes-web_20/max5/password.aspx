<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="password.aspx.vb" Inherits="ermes_web_20.password" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="max5/password.aspx">
    <h3><asp:literal runat="server" text ="Password Setup Max5" ID="password_channel" meta:resourcekey="password_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_password_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_password_newResource1" /><i></i></b>

            </div>
        </div>
    <script type="text/javascript" src="max5/validator_max5_password.js"></script>
