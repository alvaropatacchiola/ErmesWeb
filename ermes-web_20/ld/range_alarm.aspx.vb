Public Class range_alarm
    ...
    Private Sub range_alarm_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_range_ld(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "high_range_alarm"), GetGlobalResourceObject("ld_global", "low_range_alarm"), GetGlobalResourceObject("ld_global", "min_max_high"), GetGlobalResourceObject("ld_global", "min_max_low"), GetGlobalResourceObject("ld_global", "time"), GetGlobalResourceObject("ld_global", "val_Mode"))
        End If
    End Sub
    Public Sub posiziona_range_ld(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_rangealarmld_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_rangealarmld_new, ""))
        ...
        Else
            set_variable_javascript(4, 1) = "-999"
        End If
    ...
    Private Function MakeMinMaxString() As String
        ...
        If cl_alarm_high_enable.Checked = True Then 'enable ch2 H
            ...
            app = Val(value_cl_alarm_high.Text) * fattore_divisione_temp

            If app >= 0 Then
                app_value_ch2_H = Format(Val(value_cl_alarm_high.Text) * fattore_divisione_temp, "0000")
            Else
                app_value_ch2_H = Format(Val(value_cl_alarm_high.Text) * fattore_divisione_temp, "000")
            End If
        ...
        If cl_alarm_low_enable.Checked = True Then 'enable ch2 L
            ...
            app = Val(value_cl_alarm_low.Text) * fattore_divisione_temp

            If app >= 0 Then
                app_value_ch2_L = Format(Val(value_cl_alarm_low.Text) * fattore_divisione_temp, "0000")
            Else
                app_value_ch2_L = Format(Val(value_cl_alarm_low.Text) * fattore_divisione_temp, "000")
            End If
    ...
    Protected Sub save_rangealarmld_new_Click(sender As Object, e As EventArgs) Handles save_rangealarmld_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=3" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
