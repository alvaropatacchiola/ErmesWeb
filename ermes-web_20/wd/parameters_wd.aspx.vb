Public Class WebForm7
    ...
    Private Sub parameters_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_parameters_wd(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output", "Probe Failure Alarm")
        End If
    End Sub
    Public Sub posiziona_parameters_wd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_parameters_wd_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_parameters_wd_new, ""))
    ...
    End Function
    Protected Sub save_parameters_wd_new_Click(sender As Object, e As EventArgs) Handles save_parameters_wd_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=5" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
