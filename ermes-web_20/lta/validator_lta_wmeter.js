...
$("#save_wmeterlta_new").click(function () {
    ...
    Changed_channel('value_timeout', 'riga1_timeout', 20, 0, 0);
    ...
    if ((valore) ||
        ...
        $('#save_wmeterlta_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
