...
Public Class clock_ldt
    ...
    Private Sub clock1_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_clock_ldtower(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output")
        End If
    End Sub

    Public Sub posiziona_clock_ldtower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
    ...
    Protected Sub save_clock_new_Click(sender As Object, e As EventArgs) Handles save_clock_new.Click
        ...
        Response.Redirect("~/ldtower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=11" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
