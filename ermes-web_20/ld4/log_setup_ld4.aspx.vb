Public Class log_setup_ld4
    ...
    Private Sub log_setup_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_log_ld4(nome_impianto, codice_impianto, id_485_impianto, canale)
        End If
    End Sub
    Public Sub posiziona_log_ld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        save_logsetupld4_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_logsetupld4_new, ""))
    ...
    Protected Sub save_logsetupld4_new_Click(sender As Object, e As EventArgs) Handles save_logsetupld4_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=37" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
