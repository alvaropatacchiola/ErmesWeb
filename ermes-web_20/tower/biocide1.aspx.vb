Public Class biocide1
    ...
    Private Sub biocide1_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
   Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_biocide1_tower(nome_impianto, codice_impianto, id_485_impianto, canale)
        End If
    End Sub
    Public Sub posiziona_biocide1_tower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        Dim biocide1_value() As String
        Dim biocide1_w1_value() As String
        Dim biocide1_w2_value() As String
        Dim biocide1_w3_value() As String
        Dim biocide1_w4_value() As String
        ...
        biocide1_value = main_function.get_split_str(riga_strumento.value15)
        biocide1_w1_value = main_function.get_split_str(riga_strumento.value16)
        biocide1_w2_value = main_function.get_split_str(riga_strumento.value17)
        biocide1_w3_value = main_function.get_split_str(riga_strumento.value18)
        biocide1_w4_value = main_function.get_split_str(riga_strumento.value19)
        ...
        function_java = function_java + create_biocide1(optio_value(0), biocide1_value(0), measure_unit, version_str, full_scale_temp, MTower_Type)
        ...
        End If
        function_java = function_java + create_biocide_week("1", biocide1_w1_value, international_unit, biocide1_week1_lunedi, value_biocide1_week1_lunedi_hr, value_biocide1_week1_lunedi_min, value_biocide1_week1_lunedi_feed, _
        ...
        function_java = function_java + create_biocide_week("2", biocide1_w2_value, international_unit, biocide1_week2_lunedi, value_biocide1_week2_lunedi_hr, value_biocide1_week2_lunedi_min, value_biocide1_week2_lunedi_feed, _
                            biocide1_week2_martedi, value_biocide1_week2_martedi_hr, value_biocide1_week2_martedi_min, value_biocide1_week2_martedi_feed, _
                            biocide1_week2_mercoledi, value_biocide1_week2_mercoledi_hr, value_biocide1_week2_mercoledi_min, value_biocide1_week2_mercoledi_feed, _
                            ...
                            biocide1_week2_venerdi, value_biocide1_week2_venerdi_hr, value_biocide1_week2_venerdi_min, value_biocide1_week2_venerdi_feed, _
                            biocide1_week2_sabato, value_biocide1_week2_sabato_hr, value_biocide1_week2_sabato_min, value_biocide1_week2_sabato_feed, _
                             biocide1_week2_domenica, value_biocide1_week2_domenica_hr, value_biocide1_week2_domenica_min, value_biocide1_week3_domenica_feed)
        function_java = function_java + create_biocide_week("3", biocide1_w3_value, international_unit, biocide1_week3_lunedi, value_biocide1_week3_lunedi_hr, value_biocide1_week3_lunedi_min, value_biocide1_week3_lunedi_feed, _
        ...
        function_java = function_java + create_biocide_week("4", biocide1_w4_value, international_unit, biocide1_week4_lunedi, value_biocide1_week4_lunedi_hr, value_biocide1_week4_lunedi_min, value_biocide1_week4_lunedi_feed, _
    ...
    End Function
    Private Function create_biocide1(ByVal option_value As String, ByVal biocide1_value As String, ByVal SelectedMeasureUnit As String, ByVal version_str As String,
                                ByVal full_scale_temp As Integer, ByVal MTower_Type As String) As String
        Dim set_variable_javascript(1, 1) As String
        Dim function_java As String = ""
        Dim java_script_variable As java_script = New java_script
        ...
        If (MTower_Type = "Cdxxx") Then
            weekCounter = Val(Mid(option_value, 28, 2))
        End If
        If (MTower_Type = "Cd_pH") Or (MTower_Type = "Cd_rH") Or (MTower_Type = "Cd_Cl") Then
            weekCounter = Val(Mid(option_value, 36, 2))
        End If
        If (MTower_Type = "Cd_pH_Cl") Or (MTower_Type = "Cd_trc_Cl") Or (MTower_Type = "Cd_pH_rH") Then
            weekCounter = Val(Mid(option_value, 44, 2))
        End If
        'Select Case Val(Mid(option_value, 36, 2))
        Select Case weekCounter
            Case 1
    ...
    Private Function MakeBiocide1() As String
        ...
        'Return stato_server
        Return id_485_impianto + "bioc1wMT" + Risultato + "bioc1wend" & Chr(13)
    End Function
    Private Function MakeBiocide1Week1String() As String
        ...
        'Return stato_server
        Return id_485_impianto + "bi1w1w" + Risultato + "bi1w1wend" & Chr(13)
    ...
    Private Function MakeBiocide1Week2String() As String
        ...
        'Return stato_server
        Return id_485_impianto + "bi1w2w" + Risultato + "bi1w2wend" & Chr(13)
    ...
    Private Function MakeBiocide1Week3String() As String
        ...
        'Return stato_server
        Return id_485_impianto + "bi1w3w" + Risultato + "bi1w3wend" & Chr(13)
    End Function
    ...
    Private Function MakeBiocide1Week4String() As String
        ...
        Return id_485_impianto + "bi1w4w" + Risultato + "bi1w4wend" & Chr(13)
        'Return stato_server
    ...
    Protected Sub save_biocide1tower_new_Click(sender As Object, e As EventArgs) Handles save_biocide1tower_new.Click
        ...
        Response.Redirect("~/tower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=2" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
