<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message.aspx.vb" Inherits="ermes_web_20.message1" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="ldma/message.aspx">
    <h3><asp:literal runat="server" text ="Message LD mA" ID="message_channel" meta:resourcekey="message_channelResource1" ></asp:literal></h3>
    <div class="innerLR">
...
<!-- tab 2 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_message_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_message_newResource1"  /><i></i></b>
                </div>


            </div>
        </div>
    <script type="text/javascript" src="ldma/validator_ldma_message.js"></script>
