<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="system_lta.aspx.vb" Inherits="ermes_web_20.system_lta" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="lta/system_lta.aspx">
...
<div class="controlli_testo_box">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal8"  text="View Cl" runat="server" meta:resourcekey="LiteralResource10"></asp:literal></h5>
                        ...
                        <div id ="div1" class="row-fluid">
                        	<div class="span3">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal_user"  text="User Password:" runat="server" meta:resourcekey="Literal_user_Resource19"></asp:literal></h5>
                                <asp:textbox ID="value_user_p" class="span12"  runat="server" style=" position: relative; z-index: 100000; top: 0px; left: 0px;" MaxLength="4" TextMode="Password" meta:resourcekey="value_user_pResource1"></asp:textbox>
                            </div>

                     </div>


                        <div id ="riga_dos_check" class="row-fluid">
                        	<div class="span3">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal_dos"  text="Dose Check:" runat="server" meta:resourcekey="Literal_dos_Resource19"></asp:literal></h5>
                                <asp:textbox ID="value_dos_check" onblur="javascript: Changed_channel( 'value_dos_check','riga_dos_check',50, 10,0);" class="span12"  runat="server" style=" position: relative; z-index: 100000; top: 0px; left: 0px;" MaxLength="2" meta:resourcekey="value_dos_checkResource1"></asp:textbox>
                            </div>
...
<div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_systemlta_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_systemlta_newResource1" /><i></i></b>
                </div>
            </div>
        <script type="text/javascript" src="lta/validator_lta_system.js"></script>
