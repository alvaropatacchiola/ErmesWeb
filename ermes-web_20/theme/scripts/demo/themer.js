...
[
	...
	".cssmenu ul li.dashboard",
	".cssmenu .dropdown-menu > li > a:hover",
	".cssmenu .dropdown-menu > .active > a, .cssmenu .dropdown-menu > .active > a:hover, .cssmenu .dropdown-menu > .active > a:focus"
];
