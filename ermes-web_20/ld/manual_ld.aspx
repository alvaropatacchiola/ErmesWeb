<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="manual_ld.aspx.vb" Inherits="ermes_web_20.manual_ld" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>




<form id="form" runat="server"  method="post" action="ld/manual_ld.aspx">
...
<div class="controlli_box">
                   <asp:radiobutton ID="check_pulse1_id"  runat="server" meta:resourcekey="check_pulse1_idResource1" GroupName="manuald" ></asp:radiobutton>
</div>                       
                </div>
                </div>
	<div class="span2">
...
<div class="controlli_box">
                   <asp:radiobutton ID="check_pulse2_id"  runat="server" meta:resourcekey="check_pulse2_idResource1" GroupName="manuald" ></asp:radiobutton>
</div>                       
                </div>
                </div>
	<div class="span2">
...
<div class="controlli_box">
                   <asp:radiobutton ID="check_pulse3_id"  runat="server" meta:resourcekey="check_pulse3_idResource1" GroupName="manuald" ></asp:radiobutton>
</div>                       
                </div>
                </div>
	<div class="span2">
...
<!-- tab 2 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_manual_newld" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_manual_newldResource1" /><i></i></b>
                </div>
    ...
    <script type="text/javascript" src="ld/validator_ld_manual.js"></script>
