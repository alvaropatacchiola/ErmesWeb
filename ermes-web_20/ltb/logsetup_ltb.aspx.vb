Public Class logsetup_ltb
    ...
    Private Sub log_setup_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_log_ltb(nome_impianto, codice_impianto, id_485_impianto, canale)
        End If
    End Sub
    Public Sub posiziona_log_ltb(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        save_logsetupltb_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_logsetupltb_new, ""))
    ...
    Private Function MakeLogSetupString() As String
        ...
        If Val(formato_d) = 3 Then ' italiano
            app_am_log = "1"
            app_pm_log = "0"
        End If
        ...
        If Val(formato_d) = 2 Then ' americano
            If InStr(value_log_time_12.Text, "pm") Then 'pm
                app_am_log = "0"
                app_pm_log = "1"
            End If
    ...
    Protected Sub save_logsetupltb_new_Click(sender As Object, e As EventArgs) Handles save_logsetupltb_new.Click
        ...
        Response.Redirect("~/ltb.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=5" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
