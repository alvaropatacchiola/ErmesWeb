...
$("#save_flowld4_new").click(function () {
    ...
    if ((alarm_flow_time)) {
        ...
        $('#save_flowld4_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
