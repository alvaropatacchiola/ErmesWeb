Public Class setpoint_wd_S
    ...
    Public Sub posiziona_setpoint_wd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_setpointwdS_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_setpointwdS_new, ""))
    ...
    Protected Sub save_setpointwdS_new_Click(sender As Object, e As EventArgs) Handles save_setpointwdS_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=12" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
