Public Class ma_outputsC
    ...
    Private Sub ma_outputs_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_ma_ldsC(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "max_ma"), GetGlobalResourceObject("ld_global", "min_ma"), GetGlobalResourceObject("ld_global", "min_temperature"), GetGlobalResourceObject("ld_global", "max_temperature"))
        End If

    End Sub
    Public Sub posiziona_ma_ldsC(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_maoutputldsC_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_maoutputldsC_new, ""))
        ...
        Dim mode_pid As String
        Dim ch_pid As String
        ...
        mode_pid = Mid(maoutstr_value(7), 1, 1)
        ch_pid = Mid(maoutstr_value(8), 1, 1)
        ...
        If mode_pid = "0" Then '0/20mA
            pid_0_20.Checked = True
        End If
        If mode_pid = "1" Then '4/20mA
            pid_4_20.Checked = True
        End If


        If ch_pid = "0" Then 'nessuno
            pid_P1.Checked = False
            pid_P2.Checked = False
            pid_R1.Checked = False
            pid_R2.Checked = False
        End If
        If ch_pid = "1" Then 'nessuno
            pid_P1.Checked = True
          
        End If
        If ch_pid = "2" Then 'nessuno

            pid_P2.Checked = True
           
        End If
        If ch_pid = "3" Then 'nessuno
         
            pid_R1.Checked = True

        End If
        If ch_pid = "4" Then 'nessuno
    ...
    Private Function MakeMAString() As String
        ...
        Dim app_mode_pid As String
        Dim app_ch_pid As String
        ...
        If pid_0_20.Checked = True Then '0/20 temp
            app_mode_pid = "0"
        End If
        If pid_4_20.Checked = True Then '4/20 temp
            app_mode_pid = "1"
        End If


        app_ch_pid = "0"
        If pid_P1.Checked = True Then
            app_ch_pid = "1"
        End If
        If pid_P2.Checked = True Then
            app_ch_pid = "2"
        End If
        If pid_R1.Checked = True Then
            app_ch_pid = "3"
        End If
        If pid_R2.Checked = True Then
            app_ch_pid = "4"
        End If
        ...
        Risultato = app_mode_ch1 + app_max_ch1_s + app_min_ch1_s + app_mode_temp + app_max_temp_s + app_min_temp_s + app_mode_pid + app_ch_pid

        Return id_485_impianto + "maoutw" + Risultato + "maoutwend" & Chr(13)

    End Function
    Protected Sub save_maoutputldsC_new_Click(sender As Object, e As EventArgs) Handles save_maoutputldsC_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=56" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
