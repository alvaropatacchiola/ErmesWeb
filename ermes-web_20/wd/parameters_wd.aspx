...
<form id="form" runat="server" method="post" action="wd/parameters_wd.aspx">
...
<div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_parameters_wd_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_parameters_wd_newResource1" /><i></i></b>
                </div>
            </div>
        <script type="text/javascript" src="wd/validator_wd_parameters.js"></script>
