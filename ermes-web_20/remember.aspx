                  ...
                  <div class="card-header pb-0">
                    <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                      <a class="w-auto pl-0">
                        ...
                        <span class="brand-name text-dark"> <asp:Literal ID="Literal1" runat="server" Text="Non Ricordo la mia Username e/o Password" meta:resourcekey="Literal1Resource1" ></asp:Literal></span>
                      </a>
                    </div>
                  </div>
                  ...
                  <form id="form1" runat="server">
                      <div class="row">
                        ...
                        <div class="form-group col-md-12 mb-4">
                            <asp:textbox class="span12" runat="server"   id="email_val" name="mail" placeholder="Enter your email address" type="text" meta:resourcekey="email_valResource1" CssClass="form-control input-lg" />
                        ...
                        <div class="col-md-12">
                          ...
                          <asp:Button class="btn btn-block btn-primary" ID="Button1" runat="server" Text="Invia"  OnClientClick="return (check_button1());" meta:resourcekey="Button1Resource1" OnClick="Button1_Click" />
