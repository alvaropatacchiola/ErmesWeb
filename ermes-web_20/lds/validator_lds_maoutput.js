...
$("#save_maoutputlds_new").click(function () {
    ...
    if ( (cl_ma_max) || (cl_ma_min) ||
        ...
        $('#save_maoutputlds_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
