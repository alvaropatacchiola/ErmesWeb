<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="setpoint_wd_2_magneti.aspx.vb" Inherits="ermes_web_20.WebForm1" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="wd/setpoint_wd_2_magneti.aspx">
...
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal10"  text="Pulse Speed (min)" runat="server" meta:resourcekey="Literal10Resource1"></asp:literal></h5>
...
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal45"  text="Pulse Speed (min)" runat="server" meta:resourcekey="Literal45Resource1"></asp:literal></h5>
...
<!-- tab 4 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_setpointwd_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_setpointwd_newResource1" /><i></i></b>

            </div>
        </div>
        </div>
<script type="text/javascript" src="wd/validator_wd_2_magneti.js"></script>
