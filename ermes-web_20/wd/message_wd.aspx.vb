Public Class message_wd
    ...
    Private Sub message_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_messagewd(nome_impianto, codice_impianto, id_485_impianto)

        End If

    End Sub
    Public Sub posiziona_messagewd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String)
        ...
        save_message_newwd.OnClientClick = String.Format("salva_dati(""{0}""); return false;",
                    ClientScript.GetPostBackEventReference(save_message_newwd, ""))
    ...
    Protected Sub save_message_newwd_Click(sender As Object, e As EventArgs) Handles save_message_newwd.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=17" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
