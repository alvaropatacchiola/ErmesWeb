<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Dosing_Alarm_wd_140.aspx.vb" Inherits="ermes_web_20.Dosing_Alarm_wd_140" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="wd/Dosing_Alarm_wd_140.aspx">
...
<!-- tab 2 stop-->  
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" data-layout="center" data-type="confirm" data-toggle="notyfy" ID="save_alarmdosingwd_140_new" class="btn-primary"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_alarmdosingwd_140_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
                <script type="text/javascript" src="wd/validator_wd_dosing_alarm_140.js"></script>
