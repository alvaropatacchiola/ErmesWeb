Public Class main_max5
    ...
    Private Function crea_header(ByVal str_input() As String, ByVal temperatura_traduzione As String, ByVal option_str() As String,
                                 ByVal tipo_personalizzazione As String, ByVal Flow_meter_traduzione As String, ByVal Totalizer_traduzione As String, ByVal alarm_value_general() As String, ByVal number_version As Integer,
                                 ByVal flow_traduzione As String, ByVal stby_traduzione As String, ByVal clean_traduzione As String,
    ...
    Private Function crea_canale(ByVal numero_canale As Integer, ByVal Channel_traduzione As String, ByVal label_canale As String,
                                 ...
                                 ByVal Uscite_traduzione As String, ByVal info_canale As String, ByVal livello_canale As String, ByVal number_version As Integer,
