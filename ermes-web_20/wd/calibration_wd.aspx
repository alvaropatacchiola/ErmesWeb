<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calibration_wd.aspx.vb" Inherits="ermes_web_20.calibration_wd" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="wd/calibration_wd.aspx">


    <h3><asp:literal runat="server" text ="Calibration WD" ID="calibration_channel" meta:resourcekey="calibration_channelResource1"></asp:literal></h3>
    <div class="innerLR">
 ...
 <!-- fine riga -->                                    
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_calibration_newwd" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_temperature_newwdResource1" /><i></i></b>
                </div>

            </div>
        </div>
    <script type="text/javascript" src="wd/validator_wd_calibration.js"></script>
