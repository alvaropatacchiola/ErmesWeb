Public Class setpoint_ld4
    ...
    Private Sub setpoint_ld_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_setpoint_ld4(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "setpoint"))
        End If
    End Sub
    Public Sub posiziona_setpoint_ld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_setpointld4_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_setpointld4_new, ""))
        ...
        Dim ch1_relay_mode As String = Mid(data_sp(5), 1, 1) ' 0-> prop PWM  1-> on/off 2-> Fixed PWM 3-> OFF
        ...
        Dim ch2_relay_mode As String = Mid(data_sp(10), 1, 1) ' 0-> prop PWM 
        function_java = ""
        ...
        'setting_label_setpoint(etichetta_setpoint, "1", GetGlobalResourceObject("ld_global", "pulse"), GetLocalResourceObject("Literal14Resource1.Text"), GetLocalResourceObject("Literal18Resource1.Text"), Label7, Literal1, Literal6, Literal3, Literal2, Literal7, Literal4, Literal5, label_canale_temp)
        ...
        temp_calc = Val(Mid(data_sp(6), 1, 4)) / fattore_divisione_temp2 'on
        ...
        value2_ph_relay_1.Text = Format(Val(Mid(data_sp(3), 1, 3)), "000")
        value2_ph_relay_2.Text = Format(Val(Mid(data_sp(4), 1, 3)), "000")

        'value2_cl_pulse1_1.Text = Format(Val(Mid(data_sp(20), 1, 3)), "000")
        'value2_cl_pulse1_2.Text = Format(Val(Mid(data_sp(21), 1, 3)), "000")

        value2_cl_relay_1.Text = Format(Val(Mid(data_sp(8), 1, 3)), "000")
        value2_cl_relay_2.Text = Format(Val(Mid(data_sp(9), 1, 3)), "000")
    ...
    Private Function MakeSETString() As String
        ...
        Risultato = app_ch1_relay_val1 + app_ch1_relay_val2 + app_ch1_relay_perc1 + app_ch1_relay_perc2 + app_ch1_relay_mode + app_ch2_relay_val1 + app_ch2_relay_val2 + app_ch2_relay_perc1 + app_ch2_relay_perc2 + app_ch2_relay_mode
        Return id_485_impianto + "setpnw" + Risultato + "setpnwend" & Chr(13)
    End Function
    Protected Sub save_setpointld4_new_Click(sender As Object, e As EventArgs) Handles save_setpointld4_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=29" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
