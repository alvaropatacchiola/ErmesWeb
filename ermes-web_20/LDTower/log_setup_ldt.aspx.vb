Public Class log_setup_ldt
        ...
        Private Sub log_setup1_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
            ...
            posiziona_log_ldtower(nome_impianto, codice_impianto, id_485_impianto, canale)
            End If
        End Sub
    Public Sub posiziona_log_ldtower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        save_logsetup_ldtower_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                        ClientScript.GetPostBackEventReference(save_logsetup_ldtower_new, ""))
    ...
    Protected Sub save_logsetup_ldtower_new_Click(sender As Object, e As EventArgs) Handles save_logsetup_ldtower_new.Click
        ...
        Response.Redirect("~/ldtower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=8" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
