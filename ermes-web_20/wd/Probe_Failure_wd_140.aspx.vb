Public Class Probe_Failure_wd_140
    Inherits lingua
    ...
    Private Sub probe_failure_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_failure_wd_140(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output", GetGlobalResourceObject("ld_global", "probe_failure"))
        End If
    End Sub
    Public Sub posiziona_failure_wd_140(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_probefailurewd_140_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_probefailurewd_140_new, ""))
    ...
    End Function
    Protected Sub save_probefailurewd_140_new_Click(sender As Object, e As EventArgs) Handles save_probefailurewd_140_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=23" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
