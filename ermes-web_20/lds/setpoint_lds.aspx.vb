Public Class setpoint_lds
    ...
    Private Sub setpoint_lds_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_setpoint_lds(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "setpoint"))
        End If
    End Sub
    Public Sub posiziona_setpoint_lds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_setpointlds_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_setpointlds_new, ""))
        ...
        Dim ch2_pulse_mode As String = Mid(data_sp(6), 1, 1) ' 0-> on/off 1-> prop 2-> OFF
        Dim ch2_relay_mode As String = Mid(data_sp(11), 1, 1) ' 0-> prop PWM  1-> on/off 2-> Fixed PWM 3-> OFF
        function_java = ""
        ...
        set_variable_javascript(0, 0) = "max_ch2_value"
        set_variable_javascript(0, 1) = full_scale_temp.ToString
        set_variable_javascript(1, 0) = "min_ch2_value"
        set_variable_javascript(1, 1) = "0"
        set_variable_javascript(2, 0) = "max_fix_value2"
        set_variable_javascript(2, 1) = set_fullscale(full_scale_temp).ToString
        java_script_ch1_pulse_variable.set_url_setpoint(Page, set_variable_javascript, 2)
        ...
        tabld1_2.Text = label_canale_temp + " " + GetGlobalResourceObject("ld_global", "relay")

        setting_label_setpoint(etichetta_setpoint, "", GetGlobalResourceObject("ld_global", "pulse"), GetLocalResourceObject("Literal34Resource1.Text"), GetLocalResourceObject("Literal35Resource1.Text"), Literal10, Literal29, Literal30, Literal31, Literal32, Literal33, Literal34, Literal35, label_canale_temp, GetGlobalResourceObject("ld_global", "val_ON"), GetGlobalResourceObject("ld_global", "val_OFF"))

        setting_label_setpoint_relay(etichetta_setpoint, GetGlobalResourceObject("ld_global", "relay"), Literal11, Literal38, Literal39, Literal40, Literal41, Literal42, Literal43, Literal44, Literal45, label_canale_temp, GetGlobalResourceObject("ld_global", "val_ON"), GetGlobalResourceObject("ld_global", "val_OFF"), GetGlobalResourceObject("ld_global", "val_sec"))

        Dim temp_calc As Single = Val(Mid(data_sp(1), 1, 4)) / fattore_divisione_temp 'on
       

        temp_calc = Val(Mid(data_sp(1), 1, 4)) / fattore_divisione_temp 'on
        ...
        value2_cl_pulse1_1.Text = Format(Val(Mid(data_sp(3), 1, 3)), "000")
        value2_cl_pulse1_2.Text = Format(Val(Mid(data_sp(4), 1, 3)), "000")

        value2_cl_relay_1.Text = Format(Val(Mid(data_sp(9), 1, 3)), "000")
        value2_cl_relay_2.Text = Format(Val(Mid(data_sp(10), 1, 3)), "000")

        Dim ch2_pulse_att As Integer = Val(Mid(data_sp(5), 1, 2))
    ...
    Private Sub setting_label_setpoint_relay(ByVal etichetta_setpoint As String, ByVal traduzione_relay As String, ByVal literal1 As Literal, _
                                       ...
                                       ByVal Literal4_1 As Literal, ByVal Literal5 As Literal, ByVal Literal5_1 As Literal, ByVal LiteralTipo As String, ByVal traduzione_on As String, ByVal traduzione_off As String, ByVal traduzione_sec As String)
    ...
    Private Function MakeSETString() As String
        ...
        Risultato = app_ch2_pulse_val1 + app_ch2_pulse_val2 + app_ch2_pulse_perc1 + app_ch2_pulse_perc2 + app_ch2_pulse_att + app_ch2_pulse_mode + app_ch2_relay_val1 + app_ch2_relay_val2 + app_ch2_relay_perc1 + app_ch2_relay_perc2 + app_ch2_relay_mode
        Return id_485_impianto + "setpnw" + Risultato + "setpnwend" & Chr(13)
    End Function
    Protected Sub save_setpointlds_new_Click(sender As Object, e As EventArgs) Handles save_setpointlds_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=10" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
