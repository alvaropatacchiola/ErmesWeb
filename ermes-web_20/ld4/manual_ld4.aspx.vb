Public Class manual_ld4
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            save_manual_newld4.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                        ClientScript.GetPostBackEventReference(save_manual_newld4, ""))
    ...
    Protected Sub save_manual_newld4_Click(sender As Object, e As EventArgs) Handles save_manual_newld4.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=40" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
