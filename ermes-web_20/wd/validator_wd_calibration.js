...
$("#save_calibration_newwd").click(function () {
    ...
    if ((var_alarm_ch1_calibration) || (var_alarm_ch2_calibration)) {
        ...
        $('#save_calibration_newwd').next('p').remove();
        $('#save_calibration_newwd').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
