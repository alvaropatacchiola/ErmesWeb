Public Class Dosing_Alarm_wd_140
    Inherits lingua
    ...
    Private Sub dosing_alarm_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_dosing_wd_140(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output", GetGlobalResourceObject("ld_global", "dosing_alarm"))
        End If
    End Sub
    Public Sub posiziona_dosing_wd_140(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_alarmdosingwd_140_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_alarmdosingwd_140_new, ""))
    ...
    End Function
    Protected Sub save_alarmdosingwd_140_new_Click(sender As Object, e As EventArgs) Handles save_alarmdosingwd_140_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=24" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
