Public Class message_lta
    ...
    End Sub
    Public Sub posiziona_messagelta(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String)
        ...
        save_message_newlta.OnClientClick = String.Format("salva_dati(""{0}""); return false;",
                    ClientScript.GetPostBackEventReference(save_message_newlta, ""))
    ...
    Protected Sub save_message_newlta_Click(sender As Object, e As EventArgs) Handles save_message_newlta.Click
        ...
        Response.Redirect("~/lta.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=7" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
