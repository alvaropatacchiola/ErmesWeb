<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="probe_failure_ld4.aspx.vb" Inherits="ermes_web_20.probe_failure_ld4" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="ld4/probe_failure_ld4.aspx">
...
<div id ="enable_value_ph_alarm_failure">
    ...
    <div class="row-fluid">
               	<div class="span12">
                       <h5 style="padding-top:10px"><asp:literal ID = "Literal3"  text="Mode" runat="server" meta:resourcekey="Literal1Resource1"></asp:literal></h5>
<div class="controlli_box">
...
<div id ="enable_value_cl_alarm_failure">
                <div class="row-fluid">
               	<div class="span3">
                       <div id="riga1_cl_alarm_failure" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal10"  text="Time Alarm(min)" runat="server" meta:resourcekey="Literal6Resource1"></asp:literal></h5>
    ...
    <div class="row-fluid">
               	<div class="span12">
                       <h5 style="padding-top:10px"><asp:literal ID = "Literal11"  text="Mode" runat="server" meta:resourcekey="Literal7Resource1"></asp:literal></h5>
<div class="controlli_box">
...
<!-- tab 2 stop-->  
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_probefailureld4_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_probefailureld4_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
                <script type="text/javascript" src="ld4/validator_ld4_probefailure.js"></script>
