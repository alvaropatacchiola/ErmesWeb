...
Public Class international_ld4
    Inherits lingua
    ...
    Private Sub international_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_international_ld4(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output")
        End If
    End Sub
    Public Sub posiziona_international_ld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_international_new_ld4.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_international_new_ld4, ""))
    ...
    End Function
    Protected Sub save_international_new_ld4_Click(sender As Object, e As EventArgs) Handles save_international_new_ld4.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=36" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
