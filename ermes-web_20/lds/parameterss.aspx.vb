Public Class parameterss
    ...
    Private Sub parameterss_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
       Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_parameters_lds(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "probe_failure"))
        End If
    End Sub
    Public Sub posiziona_parameters_lds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        Tau = Mid(parameters_value(3), 1, 2)
    ...
    Private Function MakeParamString() As String
        ...
        Risultato = new_password.Text + Format(Val(value_ph_feeding_delay.Text), "00") + Format(Val(value_ph_tau.Text), "00")
    ...
    Protected Sub save_parameters_new_Click(sender As Object, e As EventArgs) Handles save_parameters_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=16" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
