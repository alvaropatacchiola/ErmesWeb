<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="log_setup.aspx.vb" Inherits="ermes_web_20.log_setup" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="ld/log_setup.aspx">
...
<div id ="enable_value_log">
 ...
 <asp:placeholder runat="server" ID="log_12">
                       <div id="riga1_log_time_12" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal2"  text="Log Time" runat="server" meta:resourcekey="Literal2Resource1"></asp:literal></h5>
               	...
               	<div class="span3">
                       <div id="riga1_log_every_h" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal1"  text="Log Every Hour" runat="server" meta:resourcekey="Literal1Resource1"></asp:literal></h5>
             ...
             <div class="row-fluid">
               	<div class="span3">
                       <div id="riga1_log_every_m" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal3"  text="Log Every Min" runat="server" meta:resourcekey="Literal3Resource1"></asp:literal></h5>
...
<!-- tab 1 stop-->
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_logsetupld_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_logsetupld_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
    <script type="text/javascript" src="ld/validator_ld_logsetup.js"></script>
