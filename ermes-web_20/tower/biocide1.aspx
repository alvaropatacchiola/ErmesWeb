<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="biocide1.aspx.vb" Inherits="ermes_web_20.biocide1" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server"  method="post" action="tower/biocide1.aspx">
    <h3><asp:literal runat="server" text ="Biocide1 Tower" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
<div class="innerLR">
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal1"  text="Pre Biocide (Min)" runat="server" meta:resourcekey="Literal1Resource1"></asp:literal></h5>
...
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal2"  text="LockOut (Hr)" runat="server" meta:resourcekey="Literal2Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal3"  text="LockOut (Min)" runat="server" meta:resourcekey="Literal3Resource1"></asp:literal></h5>
...
<!-- tab 1 stop-->
 <!-- tab 2 start-->
			<div class="tab-pane" id="tab_tower_sp2_2">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal4"  text="Biocide1 Week1" runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_lunedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_lunedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal9"  text="Hour" runat="server" meta:resourcekey="Literal9Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal11"  text="Minute" runat="server" meta:resourcekey="Literal11Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal12"  text="Feed" runat="server" meta:resourcekey="Literal12Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal7" runat="server" meta:resourcekey="Literal7Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_martedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_martedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal14"  text="Hour" runat="server" meta:resourcekey="Literal14Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal15"  text="Minute" runat="server" meta:resourcekey="Literal15Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal16"  text="Feed" runat="server" meta:resourcekey="Literal16Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal13" runat="server" meta:resourcekey="Literal13Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_mercoledi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_mercoledi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal18"  text="Hour" runat="server" meta:resourcekey="Literal18Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal19"  text="Minute" runat="server" meta:resourcekey="Literal19Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal20"  text="Feed" runat="server" meta:resourcekey="Literal20Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal17" runat="server" meta:resourcekey="Literal17Resource1"></asp:literal></h5>
...
<div class="span2">
     ...
     <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal21" runat="server" meta:resourcekey="Literal21Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_venerdi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_venerdi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal26"  text="Hour" runat="server" meta:resourcekey="Literal26Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal27"  text="Minute" runat="server" meta:resourcekey="Literal27Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal28"  text="Feed" runat="server" meta:resourcekey="Literal28Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_sabato">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_sabato_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal30"  text="Hour" runat="server" meta:resourcekey="Literal30Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal31"  text="Minute" runat="server" meta:resourcekey="Literal31Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal32"  text="Feed" runat="server" meta:resourcekey="Literal32Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal29" runat="server" meta:resourcekey="Literal29Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week1_domenica">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week1_domenica_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal34"  text="Hour" runat="server" meta:resourcekey="Literal34Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal35"  text="Minute" runat="server" meta:resourcekey="Literal35Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal36"  text="Feed" runat="server" meta:resourcekey="Literal36Resource1"></asp:literal></h5>
...
<!-- tab 2 stop-->
			...
			<div class="tab-pane" id="tab_tower_sp3_3">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal33"  text="Biocide1 Week2" runat="server" meta:resourcekey="Literal33Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_lunedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_lunedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal38"  text="Hour" runat="server" meta:resourcekey="Literal38Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal39"  text="Minute" runat="server" meta:resourcekey="Literal39Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal40"  text="Feed" runat="server" meta:resourcekey="Literal40Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal41" runat="server" meta:resourcekey="Literal41Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_martedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_martedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal43"  text="Hour" runat="server" meta:resourcekey="Literal43Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal44"  text="Minute" runat="server" meta:resourcekey="Literal44Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal45"  text="Feed" runat="server" meta:resourcekey="Literal45Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal46" runat="server" meta:resourcekey="Literal46Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_mercoledi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_mercoledi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal48"  text="Hour" runat="server" meta:resourcekey="Literal48Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal49"  text="Minute" runat="server" meta:resourcekey="Literal49Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal50"  text="Feed" runat="server" meta:resourcekey="Literal50Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal51" runat="server" meta:resourcekey="Literal51Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_giovedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_giovedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal53"  text="Hour" runat="server" meta:resourcekey="Literal53Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal54"  text="Minute" runat="server" meta:resourcekey="Literal54Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal55"  text="Feed" runat="server" meta:resourcekey="Literal55Resource1"></asp:literal></h5>
     ...
     <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal56" runat="server" meta:resourcekey="Literal56Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_venerdi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_venerdi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal58"  text="Hour" runat="server" meta:resourcekey="Literal58Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal59"  text="Minute" runat="server" meta:resourcekey="Literal59Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal60"  text="Feed" runat="server" meta:resourcekey="Literal60Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal61" runat="server" meta:resourcekey="Literal61Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week2_sabato">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week2_sabato_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal63"  text="Hour" runat="server" meta:resourcekey="Literal63Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal64"  text="Minute" runat="server" meta:resourcekey="Literal64Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal65"  text="Feed" runat="server" meta:resourcekey="Literal65Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal66" runat="server" meta:resourcekey="Literal66Resource1"></asp:literal></h5>
...
<!-- tab 3 stop-->
			...
			<div class="tab-pane" id="tab_tower_sp4_4">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal37"  text="Biocide1 week3" runat="server" meta:resourcekey="Literal37Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_lunedi">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal52"  text="Minute" runat="server" meta:resourcekey="Literal52Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal57"  text="Feed" runat="server" meta:resourcekey="Literal57Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal62" runat="server" meta:resourcekey="Literal62Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_martedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_martedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal71"  text="Hour" runat="server" meta:resourcekey="Literal71Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal72"  text="Minute" runat="server" meta:resourcekey="Literal72Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal73"  text="Feed" runat="server" meta:resourcekey="Literal73Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_mercoledi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_mercoledi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal76"  text="Hour" runat="server" meta:resourcekey="Literal76Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal77"  text="Minute" runat="server" meta:resourcekey="Literal77Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal78"  text="Feed" runat="server" meta:resourcekey="Literal78Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal79" runat="server" meta:resourcekey="Literal79Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_giovedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_giovedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal81"  text="Hour" runat="server" meta:resourcekey="Literal81Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal82"  text="Minute" runat="server" meta:resourcekey="Literal82Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal83"  text="Feed" runat="server" meta:resourcekey="Literal83Resource1"></asp:literal></h5>
     ...
     <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal84" runat="server" meta:resourcekey="Literal84Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_venerdi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_venerdi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal86"  text="Hour" runat="server" meta:resourcekey="Literal86Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal87"  text="Minute" runat="server" meta:resourcekey="Literal87Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal88"  text="Feed" runat="server" meta:resourcekey="Literal88Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal89" runat="server" meta:resourcekey="Literal89Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_sabato">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_sabato_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal91"  text="Hour" runat="server" meta:resourcekey="Literal91Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal92"  text="Minute" runat="server" meta:resourcekey="Literal92Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal93"  text="Feed" runat="server" meta:resourcekey="Literal93Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal94" runat="server" meta:resourcekey="Literal94Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week3_domenica">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week3_domenica_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal96"  text="Hour" runat="server" meta:resourcekey="Literal96Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal97"  text="Minute" runat="server" meta:resourcekey="Literal97Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal98"  text="Feed" runat="server" meta:resourcekey="Literal98Resource1"></asp:literal></h5>
...
<!-- tab 4 stop-->
			...
			<div class="tab-pane" id="tab_tower_sp5_5">
                <h5 style="padding-top:10px"><asp:literal ID = "Literal108"  text="Week4 Inactive" runat="server" meta:resourcekey="Literal108Resource1"></asp:literal></h5>
                <asp:placeholder runat="server" ID="week4_enable">
                <div  class="box-generic">
                                 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal42"  text="Biocide1 week4" runat="server" meta:resourcekey="Literal42Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_lunedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_lunedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal75"  text="Hour" runat="server" meta:resourcekey="Literal75Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal80"  text="Minute" runat="server" meta:resourcekey="Literal80Resource1"></asp:literal></h5>
...
<div class="span2">
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal90"  text="" runat="server" meta:resourcekey="Literal90Resource1"></asp:literal></h5>
...
<div class="span2">
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal102"  text="" runat="server" meta:resourcekey="Literal102Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_mercoledi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_mercoledi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal104"  text="Hour" runat="server" meta:resourcekey="Literal104Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal105"  text="Minute" runat="server" meta:resourcekey="Literal105Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal106"  text="Feed" runat="server" meta:resourcekey="Literal106Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal107"  text="" runat="server" meta:resourcekey="Literal107Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_giovedi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_giovedi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal109"  text="Hour" runat="server" meta:resourcekey="Literal109Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal110"  text="Minute" runat="server" meta:resourcekey="Literal110Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal111"  text="Feed" runat="server" meta:resourcekey="Literal111Resource1"></asp:literal></h5>
     ...
     <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal112"  text="" runat="server" meta:resourcekey="Literal112Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_venerdi">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_venerdi_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal114"  text="Hour" runat="server" meta:resourcekey="Literal114Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal115"  text="Minute" runat="server" meta:resourcekey="Literal115Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal116"  text="Feed" runat="server" meta:resourcekey="Literal116Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal117"  text="" runat="server" meta:resourcekey="Literal117Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_sabato">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_sabato_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal119"  text="Hour" runat="server" meta:resourcekey="Literal119Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal120"  text="Minute" runat="server" meta:resourcekey="Literal120Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal121"  text="Feed" runat="server" meta:resourcekey="Literal121Resource1"></asp:literal></h5>
 ...
 <!-- riga -->
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal122"  text="" runat="server" meta:resourcekey="Literal122Resource1"></asp:literal></h5>
...
<div id ="enable_biocide1_week4_domenica">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_biocide1_week4_domenica_hr" class="control-group">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal124"  text="Hour" runat="server" meta:resourcekey="Literal124Resource1"></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal125"  text="Minute" runat="server" meta:resourcekey="Literal125Resource1"></asp:literal></h5>
...
<div class="span2">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal126"  text="Feed" runat="server" meta:resourcekey="Literal126Resource1"></asp:literal></h5>
