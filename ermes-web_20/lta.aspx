<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="lta.aspx.vb" Inherits="ermes_web_20.lta" MasterPageFile="~/main.Master" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<div id="menu_strumento">
    ...
    <ul class="nav nav-pills">
        ...
        <asp:literal ID="Label16" runat="server" Text="<li><a id ='setpointlta_id' href='#'>SetPoint</a></li>" meta:resourcekey="Label18Resource1"></asp:literal>
        <%--<asp:literal ID="Literal4" runat="server" Text="<li><a id ='flowall_lta_id' href='#'>Flow Alarm</a></li>" meta:resourcekey="Literal6Resource1"></asp:literal>--%>

       

                        <asp:literal ID="Literal47" runat="server" Text="<li><a id ='flowall_lta_id' href='#'>Flow Alarm</a></li>" meta:resourcekey="Literal47Resource1"></asp:literal>
                        <asp:literal ID="Literal57" runat="server" Text="<li><a id ='lettureall_lta_id' href='#'>Read Alarm</a></li>" meta:resourcekey="Literal57Resource1"></asp:literal>
       ...
       <!-- <asp:literal ID="Literal1" runat="server" Text="<li><a id ='manual_ltb_id' href='#'>Manual</a></li>" meta:resourcekey="Literal1Resource1"></asp:literal>-->
        ...
        <%--<asp:literal ID="Literal3" runat="server" Text="<li><a id ='calibration_lta_id' href='#'>Calibration</a></li>" meta:resourcekey="Literal3Resource1"></asp:literal>--%>

            <asp:literal ID="Label20" runat="server" Text="<li><a id ='logsetuplta_id' href='#'>Log Setup</a></li>" meta:resourcekey="Label20Resource1"></asp:literal>
        <%--<asp:literal ID="Label25" runat="server" Text="<li><a id ='ciclilta_id' href='#'>Cicli</a></li>" meta:resourcekey="Label25Resource1"></asp:literal>--%>
...
<script type="text/javascript">
    ...
    function carica_pagina(indice) {
        ...
        switch (indice) {
            case 0:
                ...
                $("#principale").load("lta/main_lta.aspx?" + sPageURL);
                break;
            case 1:

                evidenzia("", "#setpoint_lta");
                //alert("1");

                StopRefresh();
              
                $("#principale").load("lta/setpoint_lta.aspx?" + sPageURL);

                break;
            case 2:
                evidenzia("", "#wmeter_lta");
                StopRefresh();
                $("#principale").load("lta/wmeter_lta.aspx?" + sPageURL);
                break;
            ...
            case 3:
                evidenzia("", "#flow_lta");
                StopRefresh();
                $("#principale").load("lta/flow_lta.aspx?" + sPageURL);
                break;
            ...
            case 4:
                evidenzia("", "#system_lta");
                StopRefresh();
                $("#principale").load("lta/system_lta.aspx?" + sPageURL);
                break;

            case 5:
                evidenzia("", "#logsetup_lta");
                StopRefresh();
                $("#principale").load("lta/logsetup_lta.aspx?" + sPageURL);
                break;

            case 6:
                evidenzia("log_li", "#Log_1");
                StopRefresh();
                $("#principale").load("chart/log_lta.aspx?" + sPageURL);
                break;


            case 7:
                evidenzia("", "#message_lta");
                StopRefresh();
                $("#principale").load("lta/message_lta.aspx?" + sPageURL);
                break;
            
            case 8:
                evidenzia("", "#allread_lta");
                //alert("1");
                StopRefresh();
                $("#principale").load("lta/allread_lta.aspx?" + sPageURL);
                break;
            case 9:
                evidenzia("", "#Log_1");
                //alert("1");
                StopRefresh();
                $("#principale").load("chart/log_lta_ltu_ltd.aspx?" + sPageURL);
                break;

            case 10:
                evidenzia("", "#flow_minmax_lta");
                StopRefresh();
    ...
    $("#setpoint_lta").click(function () {
       
               carica_pagina(1);


    });
    $("#wmeter_lta").click(function () {
        carica_pagina(2);

    });
    $("#flow_lta").click(function () {
        carica_pagina(3);

    });
    $("#system_lta").click(function () {
        carica_pagina(4);

    });
    $("#logsetup_lta").click(function () {
        carica_pagina(5);
    ...
    $("#message_lta").click(function () {
        carica_pagina(7);

    });
    $("#allread_lta").click(function () {
        //alert("1");
        carica_pagina(8);
