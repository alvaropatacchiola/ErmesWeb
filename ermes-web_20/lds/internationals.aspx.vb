...
Public Class internationals
    ...
    Private Sub internationals_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_international_lds(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output")
        End If
    End Sub
    Public Sub posiziona_international_lds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_international_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_international_new, ""))
        ...
        clock_24_ggmmaa.Text = data_giorno + "-" + data_anno + "-" + data_anno
    ...
    End Function
    Protected Sub save_international_new_Click(sender As Object, e As EventArgs) Handles save_international_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=17" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
