<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wmeter_ltb.aspx.vb" Inherits="ermes_web_20.wmeter_ltb" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="ltb/wmeter_ltb.aspx">
...
<!-- riga -->
                    ...
                    <div class="row-fluid">
               	<div class="span12">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal2"  text="Resolution" runat="server" meta:resourcekey="Label8Resource1" ></asp:literal></h5>
<div class="controlli_box">
...
<div class="controlli_testo_box">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal7"  text="Max Flow [cmb/h]" runat="server" meta:resourcekey="Literal7Resource1" ></asp:literal></h5>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal1"  text="Timeout" runat="server" meta:resourcekey="Literal8Resource1" ></asp:literal></h5>

                       <asp:textbox ID="value_timeout" onblur="javascript: Changed_channel( 'value_timeout','riga1_timeout',99, 0,0 );" class="span12"  runat="server" MaxLength="3" meta:resourcekey="value_ph_ma_minResource1"  ></asp:textbox>
                </div>
                       </div>
...
<!-- tab 4 stop-->
                ...
                <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_wmeterltb_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_wmeterltb_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
    <script type="text/javascript" src="ltb/validator_ltb_wmeter.js"></script>
