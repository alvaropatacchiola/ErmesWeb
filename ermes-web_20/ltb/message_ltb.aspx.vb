Public Class message_ltb
    ...
    Private Sub message_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_messageltb(nome_impianto, codice_impianto, id_485_impianto)

        End If

    End Sub
    Public Sub posiziona_messageltb(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String)
        ...
        save_message_newltb.OnClientClick = String.Format("salva_dati(""{0}""); return false;",
                    ClientScript.GetPostBackEventReference(save_message_newltb, ""))
    ...
    Protected Sub save_message_newltb_Click(sender As Object, e As EventArgs) Handles save_message_newltb.Click
        ...
        Response.Redirect("~/ltb.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=7" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
