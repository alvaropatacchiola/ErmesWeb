Public Class passcode_ldt
        ...
        Private Sub passcode_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
            ...
            posiziona_passcode_ldtower(nome_impianto, codice_impianto, id_485_impianto, "Password")
            End If
        End Sub
    Public Sub posiziona_passcode_ldtower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
                     ByVal setpoint_traduzione As String)
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim password_value() As String

        save_password_new_ldtower.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                   ClientScript.GetPostBackEventReference(save_password_new_ldtower, ""))
    ...
    End Sub
        ...
        End Function
    Protected Sub save_password_new_ldtower_Click(sender As Object, e As EventArgs) Handles save_password_new_ldtower.Click
        ...
        Response.Redirect("~/ldtower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=9&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
