Public Class ltb
        ...
        If (Not IsPostBack And refresh = "0") Or (refresh = "1") Then
            ...
            refresh_ltb(nome_impianto, codice_impianto, id_485_impianto, GetGlobalResourceObject("impianto_global", "codice"), GetGlobalResourceObject("impianto_global", "referente"), statistica, GetGlobalResourceObject("impianto_global", "statistica"), GetGlobalResourceObject("impianto_global", "strumenti_attivi"), GetGlobalResourceObject("impianto_global", "allarmi"), "Log", "Log All", _
                       GetGlobalResourceObject("ld_global", "setpoint"), GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "range_alarm"), GetGlobalResourceObject("ld_global", "flow"), GetGlobalResourceObject("ld_global", "probe_failure"), GetGlobalResourceObject("ld_global", "dosing_alarm"), GetGlobalResourceObject("ld_global", "parameters"), GetGlobalResourceObject("ld_global", "international"), GetGlobalResourceObject("ld_global", "log_setup"), _
                        GetGlobalResourceObject("ld_global", "manual"), GetGlobalResourceObject("ld_global", "message"), GetGlobalResourceObject("ld_global", "calibration"), GetGlobalResourceObject("ld_global", "Meter"), GetGlobalResourceObject("ld_global", "Flowall"), GetGlobalResourceObject("ld_global", "Self"), GetGlobalResourceObject("ld_global", "Circulation"), GetGlobalResourceObject("ld_global", "System"), GetGlobalResourceObject("ld_global", "Cicli"))
            refresh_link.NavigateUrl = "~/ltb.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=0" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&&result=0&refresh=1"
        End If
    End Sub
    Private Function read_real_time(ByVal codice As String, ByVal id_485 As String) As Boolean
        ...
        Return False
    End Function
    Private Sub refresh_ltb(ByVal nome_impianto As String, ByVal codice_impianto As String, ByVal id_485_impianto As String, _
        ...
        ByVal log_setup_traduzione As String, ByVal Manual_traduzione As String, ByVal Message_traduzione As String, ByVal Calibration_traduzione As String, _
                ...
                ByVal Cicli_traduzione As String)
        ...
        Select Case riga_strumento.tipo_strumento
            Case "LTB"
                ...
                Label16.Text = "<li><a id =""setpoint_ltb"" href='#'>" + SetPoint_traduzione + "</a></li>"
                Label24.Text = "<li><a id =""wmeter_ltb"" href='#'>" + wmeter_traduzione + "</a></li>"
                Label14.Text = "<li><a id =""system_ltb"" href=""#"">" + System_traduzione + "</a></li>"

                Literal1.Text = "<li><a id =""manual_ltb"" href=""#"">" + Manual_traduzione + "</a></li>"
                Literal2.Text = "<li><a id =""message_ltb"" href='#'>" + Message_traduzione + "</a></li>"

                Literal3.Text = "<li><a id =""calibration_ltb"" href='#'>" + Calibration_traduzione + "</a></li>"

                Label20.Text = "<li><a id =""logsetup_ltb"" href=""#"">" + log_setup_traduzione + "</a></li>"

                Label25.Text = "<li><a id =""cicli_ltb"" href=""#"">" + Cicli_traduzione + "</a></li>"
                ...
                If Val(main_function.get_version(riga_strumento.nome)) < 117 Then
                    ...
                    Literal4.Text = "<li><a id =""flow_ltb"" href=""#"">" + flow_traduzione + "</a></li>"

                Else
                    Label25.Visible = True
                    Literal4.Text = "<li><a id =""flow_ltb"" href=""#"">" + allarmi_traduzione + "</a></li>"
