<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message_ld.aspx.vb" Inherits="ermes_web_20.message_ld" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="ld/message_ld.aspx">
...
<!-- tab 2 stop-->
    ...
    <script type="text/javascript" src="ld/validator_ld_message.js"></script>
