...
//});
        ...
        function result_setpoint_change(testo_parametrico,risultato) {
            var conferma = '';
    ...
    $("#principale_alert").notyfy({
        text: testo_parametrico,
        dismissQueue: true,
        layout: 'center',
        sticky: true,
        // (int | optional) the time you want it to be alive for before fading out
        time: '',
        type: conferma // alert|error|success|information|warning|primary|confirm
    });
}
...
notification['confirm'] = 'Sei sicuro di voler modificare i Valori dell\'impianto?';
notification['annulla'] = 'Modifica Impianno Annullata';
