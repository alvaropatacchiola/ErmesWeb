Public Class parameters_ldma
    ...
    Public Sub posiziona_password(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
        ...
        save_password_ldma_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_password_ldma_new, ""))
    ...
    Protected Sub save_password_ldma_new_Click(sender As Object, e As EventArgs) Handles save_password_ldma_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=51" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
