<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="international_ld4.aspx.vb" Inherits="ermes_web_20.international_ld4" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server"  method="post" action="ld4/international_ld4.aspx">
    <h3><asp:literal runat="server" text ="International LD" ID="clock_channel" meta:resourcekey="clock_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<div class="controlli_testo_box">
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_international_new_ld4" class="btn-primary"  data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_international_new_ld4Resource1" /><i></i></b>
                </div>

            </div>
        </div>
    <script type="text/javascript" src="ld4/validator_ld4_international.js"></script>
