Public Class setpoint_ldsB
    ...
    Private Sub setpoint_ld_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_setpoint_ldsB(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "setpoint"))
        End If
    End Sub
    Public Sub posiziona_setpoint_ldsB(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_setpointldsB_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_setpointldsB_new, ""))
        ...
        Dim ch2_pulse_att As Integer = Val(Mid(data_sp(16), 1, 2))
    ...
    End Function
    Protected Sub save_setpointldsB_new_Click(sender As Object, e As EventArgs) Handles save_setpointldsB_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=27" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
