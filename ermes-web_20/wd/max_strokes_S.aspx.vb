Public Class max_strokes_S
    ...
    Public Sub posiziona_max_2_magneti_wd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_maxstrokesS_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_maxstrokesS_new, ""))
    ...
    Private Function MakeSETString() As String
        ...
        ' app_val_cl = Format(value1_cl_stk, "000")





        Risultato = app_val_ph
    ...
    Protected Sub save_maxstrokesS_new_Click(sender As Object, e As EventArgs) Handles save_maxstrokesS_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=13" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
