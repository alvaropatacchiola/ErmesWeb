Public Class message_tw
    ...
    End Sub
    Private Sub message_tw_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
    ...
    Protected Sub save_message_newld_Click(sender As Object, e As EventArgs) Handles save_message_newld.Click
        ...
        Response.Redirect("~/tower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=17" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
