Public Class dosing_alarm_ld4
    ...
    Private Sub dosing_alarm_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_dosing_ld4(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "dosing_alarm"))
        End If
    End Sub
    Public Sub posiziona_dosing_ld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_alarmdosingld4_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_alarmdosingld4_new, ""))
    ...
    End Function
    Protected Sub save_alarmdosingld4_new_Click(sender As Object, e As EventArgs) Handles save_alarmdosingld4_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=34" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
