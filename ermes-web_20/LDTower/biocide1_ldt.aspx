<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="biocide1_ldt.aspx.vb" Inherits="ermes_web_20.biocide1_ldt" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<form id="form" runat="server"  method="post" action="LDTower/biocide1_ldt.aspx">              


    <h3><asp:literal runat="server" text ="Biocide1 CoolTrol" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
    ...
    <div class="tabsbar tabsbar-2">
			<ul class="row-fluid row-merge">
                ...
                <li class="span1 active" ><a id="tab_tower_sp1" href="#tab_tower_sp1_1"  data-toggle="tab"><asp:literal text="Biocide 1"  runat="server" ID="tabtower1_1" meta:resourcekey="tabtower1_1Resource1" ></asp:literal></a></li>
		        ...
		        <li class="span1"><a id="tab_tower_sp6" href="#tab_tower_sp6_6" data-toggle="tab"><asp:literal text="Day 5" runat="server" ID="tabtower1_6" meta:resourcekey="tabtower1_6Resource1"></asp:literal></a></li>
                <li class="span1"><a id="tab_tower_sp7" href="#tab_tower_sp7_7" data-toggle="tab"><asp:literal text="Day 6" runat="server" ID="tabtower1_7" meta:resourcekey="tabtower1_7Resource1"></asp:literal></a></li>
                <li class="span1"><a id="tab_tower_sp8" href="#tab_tower_sp8_8" data-toggle="tab"><asp:literal text="Day 7" runat="server" ID="tabtower1_8" meta:resourcekey="tabtower1_8Resource1"></asp:literal></a></li>
             </ul>
		</div>
		<!-- // Tabs Heading END -->
...
<!-- tab 1 stop-->
 ...
 <!-- tab 2 start-->
			<div class="tab-pane" id="tab_tower_sp2_2">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal9"  text="Biocide1 Day1" runat="server" meta:resourcekey="Literal9Resource1"></asp:literal></h5>
...
<!-- tab 2 stop-->
    ...
    <!----------------------------------------------------------------->|
			...
			<div class="tab-pane" id="tab_tower_sp3_3">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal46"  text="Biocide1 Day2" runat="server" meta:resourcekey="Literal46Resource1"></asp:literal></h5>
...
<!--------------------------------------------------------------->
 ...
 <!-------------------------PRIMO INTERVENTO ---------------------->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal83"  text="Biocide1 day3" runat="server" meta:resourcekey="Literal83Resource1"></asp:literal></h5>
...
<!--------------------------------------------------------------->
 ...
 <!-------------------------PRIMO INTERVENTO ---------------------->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal122"  text="Biocide1 day4" runat="server" meta:resourcekey="Literal122Resource1"></asp:literal></h5>
...
<!--------------------------------------------------------------->
 ...
 <!-------------------------PRIMO INTERVENTO ---------------------->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal159"  text="Biocide1 day5" runat="server" meta:resourcekey="Literal159Resource1"></asp:literal></h5>
...
<div id ="enable_biocide_day5_second">
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal171"  text="Counter Minute" runat="server" meta:resourcekey="Literal171Resource1"></asp:literal></h5>
                       <asp:textbox ID="value_biocide_count_day5_second_min" onblur="javascript: Changed_channel( 'value_biocide2_count_day5_second_min','riga_biocide_count_day5_second_min',59, 0,0 );" class="span12"  runat="server" MaxLength="2" meta:resourcekey="value_biocide_count_day5_second_minResource1" ></asp:textbox>
                </div>
                       </div>
...
<!--------------------------------------------------------------->
 ...
 <!-------------------------PRIMO INTERVENTO ---------------------->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal196"  text="Biocide1 day6" runat="server" meta:resourcekey="Literal196Resource1"></asp:literal></h5>
...
<!--------------------------------------------------------------->
 ...
 <!-------------------------PRIMO INTERVENTO ---------------------->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal233"  text="Biocide1 day7" runat="server" meta:resourcekey="Literal233Resource1"></asp:literal></h5>
