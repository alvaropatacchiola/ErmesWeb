...
$("#save_calibration_newlds").click(function () {
    ...
    if ((var_alarm_ch1_calibration)) {

        $('#save_calibration_newlds').next('p').remove();
        $('#save_calibration_newlds').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
