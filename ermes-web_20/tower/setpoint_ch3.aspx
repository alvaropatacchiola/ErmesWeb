<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="setpoint_ch3.aspx.vb" Inherits="ermes_web_20.setpoint_ch3" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server"  method="post" action="tower/setpoint_ch3.aspx">
    <h3><asp:literal runat="server" text ="Setpoint CH3" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
                ...
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_setpoint_on" class="control-group">
                           <div id="label_on">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal4"  text="ON " runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
                               </div>
                           <div id="label_on_pwm">
                ...
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_setpoint_off" class="control-group">
                           <div id="label_off">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal7"  text="OFF " runat="server" meta:resourcekey="Literal7Resource1"></asp:literal></h5>
                            </div>
                           <div id="label_off_pwm">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal8"  text="mg/l" runat="server" meta:resourcekey="Literal8Resource1"></asp:literal></h5>
                            </div>
...
<!-- riga -->
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal10"  text="Proportional P1" runat="server" meta:resourcekey="Literal10Resource1"></asp:literal></h5>
                ...
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_setpoint_p1_1" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal13"  text="mg/l" runat="server" meta:resourcekey="Literal13Resource1"></asp:literal></h5>
...
<!-- riga -->
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga_setpoint_p1_2" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal15"  text="mg/l" runat="server" meta:resourcekey="Literal15Resource1"></asp:literal></h5>
 	...
 	<div class="span2">
                       <div id="riga_setpoint_p1_2_pm" class="control-group">
                           <h5 style="padding-top:10px"><asp:literal ID = "Literal16"  text="Pulse/minute" runat="server" meta:resourcekey="Literal16Resource1"></asp:literal></h5>
...
<asp:placeholder runat="server" ID="enable_working" >
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal17"  text="Working Mode" runat="server" meta:resourcekey="Literal17Resource1"></asp:literal></h5>
