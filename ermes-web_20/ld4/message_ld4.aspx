<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message_ld4.aspx.vb" Inherits="ermes_web_20.message_ld4" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="ld4/message_ld4.aspx">
...
<!-- tab 2 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_message_newld4" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_message_newld4Resource1" /><i></i></b>
                </div>


            </div>
        </div>
    <script type="text/javascript" src="ld4/validator_ld4_message.js"></script>
