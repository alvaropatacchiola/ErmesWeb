<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="eliminaController.aspx.vb" Inherits="ermes_web_20.eliminaController" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="accordion" id="accordion2">
        ...
        <script type="text/javascript" src="common/validator_general_eliminacontroller.js"></script>
