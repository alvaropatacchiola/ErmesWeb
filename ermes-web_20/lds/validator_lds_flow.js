...
$("#save_flowlds_new").click(function () {
    ...
    if ((alarm_flow_time)) {
        $('#save_flowlds_new').next('p').remove();

        $('#save_flowlds_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
