<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calibration_ldd.aspx.vb" Inherits="ermes_web_20.calibration_ldd" %>
<form id="form" runat="server"  method="post" action="ld/calibration_ldd.aspx">
 ...
 <!-- fine riga -->                                    
    ...
    <script type="text/javascript" src="ld/validator_ldd_calibration.js"></script>
