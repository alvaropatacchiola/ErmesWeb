<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="flow_lta.aspx.vb" Inherits="ermes_web_20.flow_lta" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="lta/flow_lta.aspx">
...
<!-- tab 1 stop-->
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_flowlta_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_flowlta_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
    <script type="text/javascript" src="lta/validator_lta_flow.js"></script>
