<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="setpoint_wd_S.aspx.vb" Inherits="ermes_web_20.setpoint_wd_S" %>

<form id="form" runat="server"  method="post" action="wd/setpoint_wd_S.aspx">
...
<!-- tab 4 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_setpointwdS_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_setpointwdS_newResource1" /><i></i></b>

            </div>
        </div>
        </div>
<script type="text/javascript" src="wd/validator_wd_S.js"></script>
