<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="ermes_web_20.login" culture="auto"  uiculture="auto" meta:resourcekey="PageResource2" %>
              ...
              <div class="col-lg-6 col-md-10">
                <div class="card card-default mb-0" style="box-shadow: 1px 2px 10px 0px #333333;">
                  ...
                  <div class="card-body px-5 pb-5 pt-0">
                   ...
                   <form id="validateSubmitForm" method="get" autocomplete="off" novalidate runat="server">
                      ...
                      <div class="row">
                        <div class="form-group col-md-12 mb-4">
                          ...
                          <input type="email" class="form-control input-lg" id="email" aria-describedby="emailHelp"
                            placeholder="email"> -->
                            <asp:TextBox  ID="TextBox1N" placeholder="Username"   runat="server" CssClass="form-control input-lg" ToolTip="Username" meta:resourcekey="TextBox1NResource1" ></asp:TextBox>
                        </div>
                        <div class="form-group col-md-12 ">
                            <!--
                          <input type="password" class="form-control input-lg" id="password" placeholder="Password">
                            -->
                            <asp:TextBox  ID="TextBox2N" placeholder="Password" runat="server" TextMode="Password"  CssClass="form-control input-lg" meta:resourcekey="TextBox2NResource1"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-12 ">
                            <asp:literal  ID="Label2N" runat="server" Text="<b style='color:red'>Username e/o Password errato<b>" Visible="False" meta:resourcekey="Label2NResource1" ></asp:literal>
                        </div>
                        <div class="col-md-12">
