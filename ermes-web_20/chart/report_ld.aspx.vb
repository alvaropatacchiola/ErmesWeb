...
Public Class report_ld
    ...
    Public Sub posiziona_report(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal init_date As String, ByVal last_date As String)
        ...
        report_head.Text = report_head.Text + "<th class=""" + ch1_livello2.ID + """>" + ch1_livello2_label.Text + ch1_val_label.Text + "</th>"
        ...
        For Each dc In table_log
            ...
            report_body.Text = report_body.Text + "<td class=""" + ch1_feed.ID + """>" + decode_on_off(dc.feed_limit_ph.ToString) + "</td>"
            ...
            report_body.Text = report_body.Text + "<td class=""" + ch1_livello2.ID + """>" + decode_on_off(dc.livello2.ToString) + "</td>"

            report_body.Text = report_body.Text + "<td class=""" + ch2_val.ID + """>" + dc.valore2.ToString + "</td>"
            report_body.Text = report_body.Text + "<td class=""" + ch2_feed.ID + """>" + decode_on_off(dc.feed_limit_cl.ToString) + "</td>"
            ...
            report_body.Text = report_body.Text + "<td class=""" + ch2_level1.ID + """>" + decode_on_off(dc.livello3.ToString) + "</td>"
    ...
    Protected Function create_custom_export(ByVal local As String) As String
        ...
        End If
        If Not ch1_livello2.Checked Then
            local = Regex.Replace(local, "<th class=""" + ch1_livello2.ID + """>.*?</th>", "")
            local = Regex.Replace(local, "<td class=""" + ch1_livello2.ID + """>.*?</td>", "")
        End If
    ...
    Protected Sub refresh_log_server_Click(sender As Object, e As EventArgs) Handles refresh_log_server.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=20" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&init_date=" + init_date + "&last_date=" + last_date)
