...
function check_alarm_channel_ph_pulse1() {
    ...
    if ((ph_pulse1_on == true) || (ph_pulse1_pm1 == true) || (ph_pulse1_off == true) || (ph_pulse1_pm2 == true) ) {
...
function check_alarm_channel_cl_pulse1() {
    ...
    if ((cl_pulse1_on == true) || (cl_pulse1_pm1 == true) || (cl_pulse1_off == true) || (cl_pulse1_pm2 == true) ) {
...
//cl relay
function enable_channel_cl_relay_proportional() {
...
$("#proportional_cl_pulse1").click(function () {
    ...
    enable_channel_cl_relay_proportional();
});
...
$("#save_setpointwdPER_new").click(function () {
    if (enable_send_setpoint == false) {
        result_setpoint_change(user_setpoint_disable);
        return false;
    }

    $('#save_setpointwdPER_new').next('p').remove();
    ...
    if ((ph_pulse1_on) || (ph_pulse1_pm1) || (ph_pulse1_off) || (ph_pulse1_pm2) ||
            (cl_pulse1_on) || (cl_pulse1_pm1) || (cl_pulse1_off) || (cl_pulse1_pm2)) {
           

        $('#save_setpointwdPER_new').next('p').remove();

        $('#save_setpointwdPER_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
