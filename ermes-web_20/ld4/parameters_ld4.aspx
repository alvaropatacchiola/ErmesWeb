<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="parameters_ld4.aspx.vb" Inherits="ermes_web_20.parameters_ld4" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server" method="post" action="ld4/parameters_ld4.aspx">
			...
			<div class="tab-pane" id="tab_ld_sp2_2">
                <div  class="box-generic">
                    ...
                    <div id ="div_old_password" class="row-fluid">
                        	<div class="span3">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal5"  text="OLD Password" runat="server" meta:resourcekey="Literal3Resource1"></asp:literal></h5>
                    ...
                    <div id ="div_new_password" class="row-fluid">
                        	<div class="span3">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal6"  text="New Password" runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
                    ...
                    <div id ="div_confirm_password" class="row-fluid">
                        	<div class="span3">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal7"  text="Confirm Password" runat="server" meta:resourcekey="Literal5Resource1"></asp:literal></h5>
...
<div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_parameters_new_ld4" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_parameters_new_ld4Resource1" /><i></i></b>
                </div>
            </div>
        <script type="text/javascript" src="ld4/validator_ld4_parameters.js"></script>
