<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="parameters_wd_140.aspx.vb" Inherits="ermes_web_20.parameter_wd_140" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<%--<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="parameters_wd.aspx.vb" Inherits="ermes_web_20.WebForm7" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>--%>

<form id="form" runat="server" method="post" action="wd/parameters_wd_140.aspx">
    <h3><asp:literal runat="server" text ="Parameters WD" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Label7"  text="Mode" runat="server" meta:resourcekey="Label7Resource1"></asp:literal></h5>
                    <asp:radiobutton ID="no_priority" style="margin: 5px 10px 10px 0px;" runat="server"  GroupName="GROUP1" meta:resourcekey="no_priorityResource1"></asp:radiobutton>
                    <asp:literal runat="server" text ="No Priority" meta:resourcekey="LiteralResource1"></asp:literal>
                    <asp:radiobutton ID="ph_priority" style="margin: 5px 10px 10px 0px;" runat="server"  GroupName="GROUP1" meta:resourcekey="ph_priorityResource1"></asp:radiobutton>
...
<div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_parameters_wd_140_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_parameters_wd_140_newResource1" /><i></i></b>
                </div>
            </div>
        <script type="text/javascript" src="wd/validator_wd_parameters_140.js"></script>
