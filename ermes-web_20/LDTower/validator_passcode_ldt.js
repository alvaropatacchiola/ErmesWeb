...
$("#save_password_new_ldtower").click(function () {
    ...
    $('#save_password_new_ldtower').next('p').remove();
    ...
    if ((validator_password_old == false) || (validator_password == false)) {
        ...
        $('#save_password_new_ldtower').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + ' </span></p>');
        submit_status = false;
        error_general = false;
        return false;
