Public Class biocide1_ldt
        ...
        Private Sub biocide1_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
            ...
            posiziona_biocide1_ldtower(nome_impianto, codice_impianto, id_485_impianto, canale)
            End If
        End Sub
    Public Sub posiziona_biocide1_ldtower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        biocide_value = main_function.get_split_str(riga_strumento.value15)
        biocide_d1_value = main_function.get_split_str(riga_strumento.value16)
        biocide_d2_value = main_function.get_split_str(riga_strumento.value17)
        biocide_d3_value = main_function.get_split_str(riga_strumento.value18)
        biocide_d4_value = main_function.get_split_str(riga_strumento.value19)
        biocide_d5_value = main_function.get_split_str(riga_strumento.value27)
        biocide_d6_value = main_function.get_split_str(riga_strumento.value28)
        biocide_d7_value = main_function.get_split_str(riga_strumento.value29)
        ...
        function_java = function_java + create_biocide1(optio_value(0), biocide_value(0), measure_unit, version_str, full_scale_temp)
    ...
    Private Function create_biocide1(ByVal option_value As String, ByVal biocide1_value As String, ByVal SelectedMeasureUnit As String, ByVal version_str As String, _
        ...
        set_variable_javascript(0, 0) = "max_us"
            ...
            If Val(Mid(biocide1_value, 3, 1)) Then
        ...
        value_pre_lockout_hr.Text = Format(Val(Mid(biocide1_value, 13, 2)), "00")          ' LockOut Hour
        value_pre_lockout_min.Text = Format(Val(Mid(biocide1_value, 15, 2)), "00")          ' LockOut Minute

        value_circulation_hr.Text = Format(Val(Mid(biocide1_value, 17, 2)), "00")          ' Circulation Hour
        value_circulation_min.Text = Format(Val(Mid(biocide1_value, 19, 2)), "00")         ' circulation Minute
    ...
    End Function
    Private Function MakeBiocide1Day1String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
    ...
    Private Function MakeBiocide1Day2String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
        ...
        If biocide_day2_first.Checked Then
            ...
            If am_day2_first.Checked Then
                AM = 1
                PM = 0
            ElseIf pm_day2_first.Checked Then
                AM = 0
                PM = 1
            End If
        Else
    ...
    End Function
    Private Function MakeBiocide1Day3String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
    ...
    Private Function MakeBiocide1Day4String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
    ...
    Private Function MakeBiocide1Day5String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
        ...
        'stato_server = service.write_set_point(codice_general, id_485, id_485 + "bi1w1w" + Risultato + "bi1w1wend" & Chr(13))
        'Return stato_server
        Return id_485_impianto + "bi1w5w" + Risultato + "bi1w5wend" & Chr(13)

    End Function



    Private Function MakeBiocide1Day6String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
        ...
        'stato_server = service.write_set_point(codice_general, id_485, id_485 + "bi1w1w" + Risultato + "bi1w1wend" & Chr(13))
        'Return stato_server
        Return id_485_impianto + "bi1w6w" + Risultato + "bi1w6wend" & Chr(13)

    End Function



    Private Function MakeBiocide1Day7String() As String
        Dim riga_strumento As ermes_web_20.quey_db.strumentiRow
        Dim tabella_strumento As ermes_web_20.quey_db.strumentiDataTable
        Dim unit_value() As String
        Dim international_unit As String = ""
        ...
        'stato_server = service.write_set_point(codice_general, id_485, id_485 + "bi1w1w" + Risultato + "bi1w1wend" & Chr(13))
        'Return stato_server
        Return id_485_impianto + "bi1w7w" + Risultato + "bi1w7wend" & Chr(13)
    ...
    Protected Sub save_biocide_ldtower_new_Click(sender As Object, e As EventArgs) Handles save_biocide_ldtower_new.Click
        ...
        new_setpoint2 = MakeBiocide1Day1String()
        new_setpoint3 = MakeBiocide1Day2String()
        new_setpoint4 = MakeBiocide1Day3String()
        new_setpoint5 = MakeBiocide1Day4String()
        new_setpoint6 = MakeBiocide1Day5String()
        new_setpoint7 = MakeBiocide1Day6String()
        new_setpoint8 = MakeBiocide1Day7String()
