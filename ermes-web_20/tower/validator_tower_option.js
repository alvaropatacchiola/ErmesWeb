...
var alarm_option_Number_week = false;
...
var alarm_option_ch2_ma_h = false;
var alarm_option_ch2_ma_l = false;
var alarm_option_ch3_ma_h = false;
var alarm_option_ch3_ma_l = false;
...
function Changed_channel(id1, id2, max_ch, min_ch, myfix) {
    ...
    switch (id1) {
        ...
        case "value_option_startup_delay":
            ...
            check_alarm_option();
            break;
        case "value_option_Number_week":
            alarm_option_Number_week = var_alarm;
            check_alarm_option();
            break;
        ...
        case "value_option_ch1_ma_l":
            ...
            check_alarm_option_ma();
            break;
        case "value_option_ch2_ma_h":
            alarm_option_ch2_ma_h = var_alarm;
            check_alarm_option_ma();
            break;
        case "value_option_ch2_ma_l":
            alarm_option_ch2_ma_l = var_alarm;
            check_alarm_option_ma();
            break;
        case "value_option_ch3_ma_h":
            alarm_option_ch3_ma_h = var_alarm;
            check_alarm_option_ma();
            break;
        case "value_option_ch3_ma_l":
            alarm_option_ch3_ma_l = var_alarm;
            check_alarm_option_ma();
            break;
...
function check_alarm_option_ma() {
    if ((alarm_option_temperature_ma_h == true) || (alarm_option_temperature_ma_l == true) || (alarm_option_ch1_ma_h == true) || (alarm_option_ch1_ma_l == true)||
        (alarm_option_ch2_ma_h == true) || (alarm_option_ch2_ma_l == true) || (alarm_option_ch3_ma_h == true) || (alarm_option_ch3_ma_l == true)) {
...
$("#value_option_Number_week").keypress(function (evt) {
    return keypress_channel_number(evt);
});
...
$("#value_option_ch2_ma_h").keypress(function (evt) {
    return keypress_channel(evt);
});
$("#value_option_ch2_ma_l").keypress(function (evt) {
    return keypress_channel(evt);
});
$("#value_option_ch3_ma_h").keypress(function (evt) {
    return keypress_channel(evt);
});
$("#value_option_ch3_ma_l").keypress(function (evt) {
    return keypress_channel(evt);
});
...
$("#value_option_Number_week").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga_bleed_setpoint").removeClass('error');
    alarm_option_Number_week = false;
    check_alarm_option();
    // $("#principale").load("test.aspx");
});
...
$("#value_option_ch2_ma_h").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga_option_ch2_ma_h").removeClass('error');
    alarm_option_ch2_ma_h = false;
    check_alarm_option_ma();
    // $("#principale").load("test.aspx");
});
$("#value_option_ch2_ma_l").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga_option_ch2_ma_l").removeClass('error');
    alarm_option_ch2_ma_l = false;
    check_alarm_option_ma();
    // $("#principale").load("test.aspx");
});
$("#value_option_ch3_ma_h").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga_option_ch3_ma_h").removeClass('error');
    alarm_option_ch3_ma_h = false;
    check_alarm_option_ma();
    // $("#principale").load("test.aspx");
});
$("#value_option_ch3_ma_l").click(function () {
    //$(this).val("");
    $(this).next('p').remove();
    $("#riga_option_ch3_ma_l").removeClass('error');
    alarm_option_ch3_ma_l = false;
    check_alarm_option_ma();
    // $("#principale").load("test.aspx");
});

$("#save_optiontower_new").click(function () {
    if (enable_send_setpoint == false) {
        result_setpoint_change(user_setpoint_disable);
        return false;
    }

    $('#save_optiontower_new').next('p').remove();
    ...
    Changed_channel('value_option_Number_week', 'riga_option_number_week', 4, 1, 0);
    ...
    if (ch2_en == 1) {
        ...
        Changed_channel('value_option_ch2_ma_h', 'riga_option_ch2_ma_h', max_ch2, min_ch2, ch2_fix);
        Changed_channel('value_option_ch2_ma_l', 'riga_option_ch2_ma_l', max_ch2, min_ch2, ch2_fix);
    }
    if (ch3_en == 1) {
        Changed_channel('value_option_ch3_ma_h', 'riga_option_ch3_ma_h', max_ch3, min_ch3, ch3_fix);
        Changed_channel('value_option_ch3_ma_l', 'riga_option_ch3_ma_l', max_ch3, min_ch3, ch3_fix);
    }
    check_alarm_option_ma();
    check_alarm_option();
    if ((alarm_option_tau) || (alarm_option_coefficiente_temperatura) || (alarm_option_startup_delay) || (alarm_option_Number_week) ||
        (alarm_option_temperature_ma_h) || (alarm_option_temperature_ma_l)||(alarm_option_ch1_ma_h)||(alarm_option_ch1_ma_l)||(alarm_option_ch2_ma_h)||
        (alarm_option_ch2_ma_l)||(alarm_option_ch3_ma_h)||(alarm_option_ch3_ma_l)) {
        $('#save_optiontower_new').next('p').remove();

        $('#save_optiontower_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
