Public Class log_setup2
    ...
    Protected Sub save_log_setup_new_Click(sender As Object, e As EventArgs) Handles save_log_setup_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=54" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
