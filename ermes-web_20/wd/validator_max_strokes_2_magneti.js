...
$("#save_maxstrokes2magneti_new").click(function () {
    ...
    $('#save_maxstrokes2magneti_new').next('p').remove();
    ...
    if ((ph_stk_on) || (cl_stk_on)) {
        ...
        $('#save_maxstrokes2magneti_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
