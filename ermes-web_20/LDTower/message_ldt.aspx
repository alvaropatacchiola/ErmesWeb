<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message_ldt.aspx.vb" Inherits="ermes_web_20.message_ldt"  culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="LDTower/message_ldt.aspx">
    <h3><asp:literal runat="server" text ="Message LD" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- tab 2 start-->
  ...
  <!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal3"  text="E-Mail Number 1" runat="server" meta:resourcekey="Literal3Resource1"></asp:literal></h5>
                       <asp:textbox ID="value_mail1_id"  class="span12" onblur="javascript: keypress_check_mail( 'value_mail1_id','riga_mail_1');" runat="server" MaxLength="42" meta:resourcekey="value_mail1_idResource1"  ></asp:textbox>
                </div>
                </div>
                </div>
                 <!-- fine riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal4"  text="E-Mail Number 2" runat="server" meta:resourcekey="Literal4Resource1"></asp:literal></h5>
                       <asp:textbox ID="value_mail2_id" onblur="javascript: keypress_check_mail( 'value_mail2_id','riga_mail_2');" class="span12"  runat="server" MaxLength="42" meta:resourcekey="value_mail2_idResource1"  ></asp:textbox>
                </div>
                       </div>
                </div>
                 <!-- fine riga -->
...
<!-- tab 2 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_message_newld" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_message_newldResource1" /><i></i></b>
                </div>


            </div>
        </div>
    <script type="text/javascript" src="LDTower/validator_ldt_message.js"></script>
