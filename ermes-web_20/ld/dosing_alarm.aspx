<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dosing_alarm.aspx.vb" Inherits="ermes_web_20.dosing_alarm" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="ld/dosing_alarm.aspx">
...
<!-- tab 2 stop-->  
             ...
             <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_alarmdosingld_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_alarmdosingld_newResource1" /><i></i></b>
                </div>
            </div>
        </div>
                <script type="text/javascript" src="ld/validator_ld_dosingalarm.js"></script>
