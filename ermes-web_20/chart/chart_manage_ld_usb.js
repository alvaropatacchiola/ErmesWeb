...
function get_data(parametro1) {
    ...
    $.ajax({
        type: "POST",
        url: "chart/log_metod.aspx/get_log_ld_usb",
        ...
        success: function (response) {
            ...
            $.each(response.d, function (k, v) {
                ...
                if (res[0] != ""){
                    $("#ch1_enable_ld").show();
                    $("#ch1_val_label_ld").text(res[0]);
                    $("#ch1_val_ld").prop('checked', true)
                    label_ch1 = res[0];
                    visible = true;
                }
                else{
                    $("#ch1_enable_ld").hide();
                    $("#ch1_val_ld").prop('checked', false)
                }
                if (res[1] != ""){
                    $("#ch2_enable_ld").show();
                    $("#ch2_val_label_ld").text(res[1]);
                    $("#ch2_val_ld").prop('checked', true)
                    label_ch2 = res[1];
                }
                else{
                    $("#ch2_enable_ld").hide();
                    $("#ch2_val_ld").prop('checked', false)
                }
                if (res[2] != ""){
                    $("#ch3_enable_ld").show();
                    $("#ch3_val_label_ld").text(res[2]);
                    $("#ch3_val_ld").prop('checked', true)
                    label_ch3 = res[2];
                }
                else{
                    $("#ch3_enable_ld").hide();
                    $("#ch3_val_ld").prop('checked', false)
                }
                ...
                res1 = res[10].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_feed1.push([data, parseInt(res1[5])]);

                res1 = res[11].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_feed2.push([data, parseInt(res1[5])]);

                res1 = res[6].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_dos1.push([data, parseInt(res1[5])]);

                res1 = res[7].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_dos2.push([data, parseInt(res1[5])]);

                res1 = res[8].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_probe1.push([data, parseInt(res1[5])]);

                res1 = res[9].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_probe2.push([data, parseInt(res1[5])]);

                res1 = res[12].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_level1.push([data, parseInt(res1[5])]);

                res1 = res[13].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_level2.push([data, parseInt(res1[5])]);

                res1 = res[14].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_level3.push([data, parseInt(res1[5])]);
                ...
                res1 = res[15].split(",")
                data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                array_temperatura.push([data, parseFloat(res1[5])]);
                if (res[17].indexOf("dis") < 0) {
                    res1 = res[17].split(",")
                    data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                    array_stby.push([data, parseInt(res1[5])]);
                    $("#stby_enable").show();
                }
                else {
                    $("#stby_enable").hide();
                }
                if (res[18].indexOf("dis") < 0) {
                    res1 = res[18].split(",")
                    data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                    array_m3h.push([data, parseInt(res1[5])]);
                    $("#flow_meter_enable").show();
                }
                else {
                    
                    $("#flow_meter_enable").hide();
                    //$("#flow_meter_enable").prop('checked', false)
                }
                if (res[19].indexOf("dis") < 0) {
                    res1 = res[19].split(",")
                    data = Date.UTC(parseInt(res1[0]), parseInt(res1[1]), parseInt(res1[2]), parseInt(res1[3]), parseInt(res1[4]));
                    array_totalizer.push([data, parseFloat(res1[5])]);
                    $("#flow_meter_enable").show();
                }
                else {
                    $("#flow_meter_enable").hide();
...
function create_picker() {
    $('#graph_log_from_ld').datepicker({
        dateFormat: 'dd/mm/yy'
    });
    $('#graph_log_to_ld').datepicker({
        dateFormat: 'dd/mm/yy'
    });
    $('#graph_log_from_ld').val(init_date);
    $('#graph_log_to_ld').val(last_date);
    
}
$("#refresh_log_server_ld").click(function () {
    salva_dati_log(0);
    // myFunction_log();
...
$("#refresh_graph_ld").click(function () {
    //alert("entro");
    var newdata1 = parseDate($('#graph_log_from_ld').val(), 'dd/mm/yy');
    var newdata2 = parseDate($('#graph_log_to_ld').val(), 'dd/mm/yy');
    ...
    if ((from_difference <= 0) && (to_difference >= 0)) {
        ...
        var data1 = newdata1;
        var data2 = newdata2;
        data_report1 = $('#graph_log_from_ld').val();
        data_report2 = $('#graph_log_to_ld').val();
...
function upgrate_chart() {
    ...
    var yaxis_chart = [];
    //canale ch1
    if (($('#ch1_val_ld').is(':checked')) && (counter_series < 10)) {
    ...
    //end  canale ch1
    //canale ch2
    if (($('#ch2_val_ld').is(':checked')) && (counter_series < 10)) {
    ...
    //end  canale ch2
    //canale ch3
    if (($('#ch3_val_ld').is(':checked')) && (counter_series < 10)) {
    ...
    //end  canale ch4
    //canale ch5
    if (($('#temperature_select_ld').is(':checked')) && (counter_series < 10)) {
    ...
    //end  canale ch5
    if (($('#flow_select_ld').is(':checked')) && (counter_series < 10)) {
        series_chart.push({
            id: 'ch5_val_series',
            name: 'Flow Alarm',
            data: array_flow,
    ...
    if (($('#stby_ld').is(':checked')) && (counter_series < 10)) {
        series_chart.push({
            id: 'ch5_val_series',
            name: 'Stby',
            data: array_stby,
    ...
    if (($('#m3h_ld').is(':checked')) && (counter_series < 10)) {
    ...
    if (($('#totalizer_ld').is(':checked')) && (counter_series < 10)) {
...
function draw_tabella() {
    ...
    $('#chart_table_ld').html('<table cellpadding="0" cellspacing="0" border="0" class="display dynamicTable table table-striped table-bordered table-condensed" id="example"></table>');
