Public Class calibration_lds
    ...
    Private Sub calibration_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_calibrationlds(nome_impianto, codice_impianto, id_485_impianto, GetGlobalResourceObject("ld_global", "val_calibration"), GetGlobalResourceObject("ld_global", "val_canale"), GetGlobalResourceObject("ld_global", "val_mvprobe"), GetGlobalResourceObject("ld_global", "val_valueprobe"), GetGlobalResourceObject("ld_global", "val_valuenew"))
            'posiziona_calibrationlds(nome_impianto, codice_impianto, id_485_impianto, GetLocalResourceObject("calibration_channelResource1.Text"), "A", "A", "A", "A")

        End If
    End Sub
    Public Sub posiziona_calibrationlds(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
        ...
        Dim label_service_ma As String = ""
        Dim j As Integer
        Dim label_canale_temp As String = ""

        tabella_strumento = (Session("strumento"))
        ' abilito pulsante modifica
        save_calibration_newlds.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_calibration_newlds, ""))
    ...
    Protected Sub save_calibration_newlds_Click(sender As Object, e As EventArgs) Handles save_calibration_newlds.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=26" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
