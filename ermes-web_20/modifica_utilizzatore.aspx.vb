Public Class modifica_utilizzatore
    Inherits lingua
            ...
            For Each dc In table_user
                ...
                If primo Then
                    ...
                    For Each dc2 In lista_impianti_user
                        ...
                        i = i + 1
                    Next
                    intestazione = intestazione + "<a href=""modificautilizzatore_form.aspx?codice=" + dc.Id_user.ToString + "&utilizzatore=" + dc.nome + "&username=" + dc.username + "&password=" + dc.password + "&modifica=" + dc.setpoint.ToString + """ data-layout=""center"" data-type=""confirm"" data-toggle=""notyfy"" onclick=""javascript:elimina_user('" + dc.Id_user.ToString + "','" + dc.nome + "')""><span class=""btn btn-primary btn-warning"">" + GetGlobalResourceObject("utilizzatore_global", "modifica_user") + "</span></a>"
                    intestazione = intestazione + "<div>"
