<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="clock_ldt.aspx.vb" Inherits="ermes_web_20.clock_ldt" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>


<form id="form" runat="server"  method="post" action="LDTower/clock_ldt.aspx">             

    <h3><asp:literal runat="server" text ="Clock CoolTrol" ID="clock_channel" meta:resourcekey="clock_channelResource1"></asp:literal></h3>
    <div class="innerLR">
    ...
    <script type="text/javascript" src="LDTower/validator_clock_ldt.js"></script>
