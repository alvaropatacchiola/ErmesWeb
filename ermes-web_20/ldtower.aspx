<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="ldtower.aspx.vb" Inherits="ermes_web_20.ldtower" culture="auto" meta:resourcekey="PageResource1" uiculture="auto"%>
...
<div id="indietro" class="btn-primary">
    ...
    <asp:Label ID="Label17" runat="server" Text="<h3 class='heading-mosaic'>01 | CoolTrol Test</h3>" meta:resourcekey="Label17Resource1"></asp:Label>
    ...
    function carica_pagina(indice) {
        ...
        switch (indice) {
            case 0:
                ...
                RestartRefresh();
                $("#principale").load("LDTower/main_ldtower.aspx?" + sPageURL);
                break;
            case 1:
                evidenzia("", "#inhibitor_id");
                StopRefresh();
                $("#principale").load("LDTower/inibitore_ldt.aspx?" + sPageURL);
                break;
            case 2:
                evidenzia("biocide_li", "#biocide1_id");
                StopRefresh();
                
                $("#principale").load("LDTower/biocide1_ldt.aspx?" + sPageURL);
                
                break;
            case 3:
                evidenzia("biocide_li", "#biocide2_id");
                StopRefresh();
                $("#principale").load("LDTower/biocide2_ldt.aspx?" + sPageURL);
                break;
            case 4:
                evidenzia("", "#bleed_id");
                StopRefresh();
                $("#principale").load("LDTower/bleed_ldt.aspx?" + sPageURL);
                break;
            case 5:
                evidenzia("setting_li", "#option_id");
                StopRefresh();
                $("#principale").load("LDTower/option_ldt.aspx?" + sPageURL);
                break;
            case 6:
                evidenzia("setting_li", "#flowmeter_id");
                StopRefresh();
                $("#principale").load("LDTower/flow_meter_ldt.aspx?" + sPageURL);
                break;
            case 7:
                evidenzia("setting_li", "#alarm_id");
                StopRefresh();
                $("#principale").load("LDTower/alarm_ldt.aspx?" + sPageURL);
                break;
            case 8:
                evidenzia("setting_li", "#logsetup_id");
                StopRefresh();
                $("#principale").load("LDTower/log_setup_ldt.aspx?" + sPageURL);
                break;
            case 9:
                evidenzia("setting_li", "#passcode_id");
                StopRefresh();
                $("#principale").load("LDTower/passcode_ldt.aspx?" + sPageURL);
                break;
            case 10:
                evidenzia("setting_li", "#unit_id");
                StopRefresh();
                $("#principale").load("LDTower/units_ldt.aspx?" + sPageURL);
                break;
            case 11:
                evidenzia("setting_li", "#clock_id");
                StopRefresh();
                $("#principale").load("LDTower/clock_ldt.aspx?" + sPageURL);
                break;
            ...
            case 12:
                ...
                StopRefresh();
                $("#principale").load("chart/log_tower.aspx?" + sPageURL);          ///DA CAMBIARE CON IL NUOVO LOG!!!!!!!!!!!!!!
                break;

            case 13:
                evidenzia("", "#calibration_id");
                StopRefresh();
                $("#principale").load("LDTower/calibration_ldt.aspx?" + sPageURL);
                break;
            case 14:
                evidenzia("", "#messagge_ld_id");
                StopRefresh();
                $("#principale").load("LDTower/message_ldt.aspx?" + sPageURL);
                break;
