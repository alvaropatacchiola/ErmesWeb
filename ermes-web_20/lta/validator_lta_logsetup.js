...
$("#save_logsetuplta_new").click(function () {
    ...
    if ((log_every_alarm_h) || (log_every_alarm_m) || (log_time_alarm_24) || (log_time_alarm_12)) {
        ...
        $('#save_logsetuplta_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
