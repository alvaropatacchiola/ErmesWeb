...
function enable_channel_ph_pulse1_on_off() {
    ...
    $("#riga2_ph_pulse_ccstk").hide();
    $("#value2_ph_pulse_range").hide();

    $("#riga2_ph_pulse_setpoint").hide();
    $("#value2_ph_pulse_setpoint").hide();

    $("#riga1_ph_pulse1_1").show();
    $("#riga1_ph_pulse1_2").show();

    $("#riga_ph_pulse_conc").hide();
    $("#value_ph_pulse_conc").hide();
...
function enable_channel_ph_pulse2_on_off() {
    ...
    //PLUS
    $("#riga1_ph_pulse2_perc4").hide();
    $("#value2_ph_pulse2_perc4").hide();

    $("#riga1_ph_pulse2_perc3").hide();
    $("#value2_ph_pulse2_perc3").hide();

    $("#riga2_ph_pulse2_mch").hide();
    $("#value2_ph_pulse2_mch").hide();


    $("#riga2_ph_pulse2_range").hide();
    $("#riga2_ph_pulse2_ccstk").hide();
    $("#value2_ph_pulse2_range").hide();

    $("#riga2_ph_pulse2_setpoint").hide();
    $("#value2_ph_pulse2_setpoint").hide();

    $("#riga1_ph_pulse2_1").show();
    $("#riga1_ph_pulse2_2").show();

    $("#riga_ph_pulse2_conc").hide();
    $("#value_ph_pulse2_conc").hide();
}
//ph relay
function enable_channel_ph_relay_on_off() {
    ...
    $("#value2_ph_relay_perc4").hide();

    $("#riga1_ph_relay_perc3").hide();
    $("#value2_ph_relay_perc3").hide();

    $("#riga2_ph_relay_mch").hide();
    $("#value2_ph_realy_mch").hide();

    $("#riga2_ph_relay_range").hide();
    $("#riga2_ph_relay_ccstk").hide();
    $("#value2_ph_relay_range").hide();

    $("#riga2_ph_relay2_setpoint").hide();
    $("#value2_ph_relay2_setpoint").hide();
...
function enable_channel_cl_pulse1_on_off() {
    ...
    $("#riga2_cl_pulse_ccstk").hide();
    $("#value2_cl_pulse_range").hide();

    $("#riga2_cl_pulse_setpoint").hide();
    $("#value2_cl_pulse_setpoint").hide();

    $("#riga1_cl_pulse1_1").show();
    $("#riga1_cl_pulse1_2").show();

    $("#riga_cl_pulse_conc").hide();
    $("#value_cl_pulse_conc").hide();
...
function enable_channel_cl_relay_on_off() {
    ...
    $("#value2_cl_relay_perc4").hide();

    $("#riga1_cl_relay_perc3").hide();
    $("#value2_cl_relay_perc3").hide();

    $("#riga2_cl_relay_mch").hide();
    $("#value2_cl_realy_mch").hide();

    $("#riga2_cl_relay_range").hide();
    $("#riga2_cl_relay_ccstk").hide();
    $("#value2_cl_relay_range").hide();

    $("#riga2_cl_relay2_setpoint").hide();
    $("#value2_cl_relay2_setpoint").hide();
...
function enable_channel_cl_relay_pid() {
    ...
    $("#riga2_cl_relay_ccstk").hide();
    $("#value2_cl_relay_range").show();

    $("#riga2_cl_relay2_setpoint").show();
    $("#value2_cl_relay2_setpoint").show();
...
function enable_channel_ph_pulse2_prop_wm() {
    ph_pulse2_speed = false;
    check_alarm_channel_ph_pulse2();
    remove_allarme('value2_ph_pulse2_3', 'riga1_ph_pulse2_3');
    $("#disable_ph_pulse2").show();
    ...
    //PLUS
    $("#riga1_ph_pulse2_perc4").show();
    $("#value2_ph_pulse2_perc4").show();


    $("#riga1_ph_pulse2_perc3").show();
    $("#value2_ph_pulse2_perc3").show();

    $("#riga2_ph_pulse2_mch").show();
    $("#value2_ph_pulse2_mch").show();
...
function enable_channel_ph_pulse1_pid() {
    ...
    $("#riga2_ph_pulse_ccstk").hide();
    $("#value2_ph_pulse_range").show();

    $("#riga2_ph_pulse_setpoint").show();
    $("#value2_ph_pulse_setpoint").show();

    $("#riga1_ph_pulse1_1").hide();
    $("#riga1_ph_pulse1_2").hide();
...
function enable_channel_cl_pulse1_pid() {
    ...
    $("#riga2_cl_pulse_ccstk").hide();
    $("#value2_cl_pulse_range").show();

    $("#riga2_cl_pulse_setpoint").show();
    $("#value2_cl_pulse_setpoint").show();

    $("#riga1_cl_pulse1_1").hide();
    $("#riga1_cl_pulse1_2").hide();
...
function enable_channel_ph_pulse2_pid() {
    ph_pulse2_speed = false;
    check_alarm_channel_ph_pulse2();
    remove_allarme('value2_ph_pulse2_3', 'riga1_ph_pulse2_3');
    $("#disable_ph_pulse2").show();
    ...
    $("#riga2_ph_pulse2_range").show();
    $("#riga2_ph_pulse2_ccstk").hide();
    $("#value2_ph_pulse2_range").show();

    $("#riga2_ph_pulse2_setpoint").show();
    $("#value2_ph_pulse2_setpoint").show();

    $("#riga1_ph_pulse2_1").hide();
    $("#riga1_ph_pulse2_2").hide();
...
function enable_channel_ph_pulse1_linea() {
    ph_pulse1_speed = false;
    check_alarm_channel_ph_pulse1();
    remove_allarme('value2_ph_pulse1_3', 'riga1_ph_pulse1_3');
    $("#disable_ph_pulse1").show();
    ...
    $("#riga_ph_pulse_conc").show();
    $("#value_ph_pulse_conc").show();
}


function enable_channel_cl_pulse1_linea() {
    cl_pulse1_speed = false;
    check_alarm_channel_cl_pulse1();
    remove_allarme('value2_cl_pulse1_3', 'riga1_cl_pulse1_3');
    $("#disable_cl_pulse1").show();
    ...
    $("#riga_cl_pulse_conc").show();
    $("#value_cl_pulse_conc").show();

}

function enable_channel_ph_pulse2_linea() {
    ph_pulse2_speed = false;
    check_alarm_channel_ph_pulse2();
    remove_allarme('value2_ph_pulse2_3', 'riga1_ph_pulse2_3');
    $("#disable_ph_pulse2").show();
    ...
    $("#riga_ph_pulse2_conc").show();
    $("#value_ph_pulse2_conc").show();
}
...
function enable_channel_ph_relay_pid() {
    ...
    $("#riga2_ph_relay_ccstk").hide();
    $("#value2_ph_relay_range").show();

    $("#riga2_ph_relay2_setpoint").show();
    $("#value2_ph_relay2_setpoint").show();
...
$("#LINEA_ph_pulse1").click(function () {
    enable_channel_ph_pulse1_linea();
});
...
//PLUS
$("#Prop_WM_ph_pulse2").click(function () {
    enable_channel_ph_pulse2_prop_wm();
});
$("#PID_ph_pulse2").click(function () {
    enable_channel_ph_pulse2_pid();
});
$("#LINEA_ph_pulse2").click(function () {
    enable_channel_ph_pulse2_linea();
});
...
$("#LINEA_cl_pulse1").click(function () {
    enable_channel_cl_pulse1_linea();
});
...
$("#save_setpointlddp_new").click(function () {
    ...
    if (!($('#off_ph_pulse1').is(':checked'))) {
        ...
        Changed_channel('value2_ph_pulse1_3', 'riga1_ph_pulse1_3', 999, 0, 0);
    }
    if (!($('#off_ph_pulse2').is(':checked'))) {
        ...
        Changed_channel('value2_ph_pulse2_3', 'riga1_ph_pulse2_3', 999, 0, 0);
    }
    if (!($('#off_ph_relay').is(':checked'))) {
    ...
    if (!($('#off_cl_pulse1').is(':checked'))) {
        ...
        Changed_channel('value2_cl_pulse1_3', 'riga1_cl_pulse1_3', 999, 0, 0);
    }
    if (!($('#off_cl_relay').is(':checked'))) {
    ...
    if ((ph_pulse1_on) || (ph_pulse1_pm1) || (ph_pulse1_off) || (ph_pulse1_pm2) ||
        ...
        $('#save_setpointlddp_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
