Public Class probe_failure
    ...
    Private Sub probe_failure_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
      Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_failure_ld(nome_impianto, codice_impianto, id_485_impianto, canale, GetGlobalResourceObject("ld_global", "ma_output"), GetGlobalResourceObject("ld_global", "probe_failure"))
        End If
    End Sub
    Public Sub posiziona_failure_ld(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_probefailureld_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_probefailureld_new, ""))
    ...
    End Function
    Protected Sub save_probefailureld_new_Click(sender As Object, e As EventArgs) Handles save_probefailureld_new.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=5" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
