<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="calibration_ltb.aspx.vb" Inherits="ermes_web_20.calibration_ltb" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
<form id="form" runat="server"  method="post" action="ltb/calibration_ltb.aspx">


    <h3><asp:literal runat="server" text ="Calibration LTB" ID="calibration_channel" meta:resourcekey="calibration_channelResource1"></asp:literal></h3>
    <div class="innerLR">
 ...
 <!-- fine riga -->                                    
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_calibration_newltb" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Salva e carica i dati" Font-Bold="True" meta:resourcekey="save_temperature_newltbResource1" /><i></i></b>
                </div>

            </div>
        </div>
    <script type="text/javascript" src="ltb/validator_ltb_calibration.js"></script>
