Public Class message_ld4
    ...
    Private Sub message_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_messageld4(nome_impianto, codice_impianto, id_485_impianto)

        End If

    End Sub
    Public Sub posiziona_messageld4(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String)
        ...
        save_message_newld4.OnClientClick = String.Format("salva_dati(""{0}""); return false;",
                    ClientScript.GetPostBackEventReference(save_message_newld4, ""))
    ...
    Protected Sub save_message_newld4_Click(sender As Object, e As EventArgs) Handles save_message_newld4.Click
        ...
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=41" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
