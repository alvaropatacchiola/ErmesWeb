<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="modificautilizzatore_form.aspx.vb" Inherits="ermes_web_20.modificautilizzatore_form" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            <div class="widget">
                <div class="widget-body">
                    <div class="row-fluid">
                        <!-- gruppo-->
							<div class="span3">
								...
								<p class="muted"><asp:Literal ID="Literal8" runat="server" Text="Modifica Utilizzatore per i tuoi Impianti" meta:resourcekey="Literal8Resource1" ></asp:Literal></p>
							</div>
							<div class="span9">
                                <!--
                 ...
                 <div id="salva" class="btn-primary">
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ClientIDMode="Static" ID="save_aggiungi_utilizzatore_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy"  text="Modifica Utilizzatore" Font-Bold="True" meta:resourcekey="save_aggiungi_utilizzatore_newResource1"  /><i></i></b>
