Public Class password
    ...
    Private Sub password_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
    ...
    Public Sub set_password(ByVal date_str As String)
        ...
        set_variable_javascript(0, 1) = """" + Mid(date_str, 37, 4) + """"
    ...
    Private Function MakePassword() As String
        ...
        risultato = id_485_impianto + "b2ph" + new_password.Text + "end" & Chr(13)
        Return risultato
    ...
    Protected Sub save_password_new_Click(sender As Object, e As EventArgs) Handles save_password_new.Click
        ...
        Response.Redirect("~/max5.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=12&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
