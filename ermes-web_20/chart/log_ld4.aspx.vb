...
Public Class log_ld4
    ...
    Public Sub posiziona_log(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
        ...
        Dim table_log As ermes_web_20.quey_db.ld4_logDataTable = New ermes_web_20.quey_db.ld4_logDataTable
        ...
        For i = 1 To numero_canali
            ...
            Select Case i
                Case 1
                    set_variable_javascript(17 + i, 0) = "label_ch1"
                    set_variable_javascript(17 + i, 1) = """" + label_canale_temp + """"
                    ch1_val_label.Text = label_canale_temp
                Case 2
                    set_variable_javascript(17 + i, 0) = "label_ch2"
                    set_variable_javascript(17 + i, 1) = """" + label_canale_temp + """"
                    ch2_val_label.Text = label_canale_temp
                Case 3
                    set_variable_javascript(17 + i, 0) = "label_ch3"
                    set_variable_javascript(17 + i, 1) = """" + label_canale_temp + """"
                    ch3_val_label.Text = label_canale_temp
                Case 4
                    set_variable_javascript(17 + i, 0) = "label_ch4"
                    set_variable_javascript(17 + i, 1) = """" + label_canale_temp + """"
        ...
        set_variable_javascript(4, 0) = "array_feed1"
        set_variable_javascript(4, 1) = "["
        set_variable_javascript(5, 0) = "array_feed2"
        set_variable_javascript(5, 1) = "["
        set_variable_javascript(6, 0) = "array_feed3"
        set_variable_javascript(6, 1) = "["
        set_variable_javascript(7, 0) = "array_feed4"
        set_variable_javascript(7, 1) = "["

        set_variable_javascript(8, 0) = "array_dos1"
        set_variable_javascript(8, 1) = "["
        set_variable_javascript(9, 0) = "array_dos2"
        set_variable_javascript(9, 1) = "["

        set_variable_javascript(10, 0) = "array_probe1"
        set_variable_javascript(10, 1) = "["
        set_variable_javascript(11, 0) = "array_probe2"
        set_variable_javascript(11, 1) = "["

        set_variable_javascript(12, 0) = "array_level1"
        set_variable_javascript(12, 1) = "["
        set_variable_javascript(13, 0) = "array_level2"
        set_variable_javascript(13, 1) = "["


        set_variable_javascript(14, 0) = "array_flow"
        set_variable_javascript(14, 1) = "["
        set_variable_javascript(15, 0) = "array_temperatura"
        set_variable_javascript(15, 1) = "["
        set_variable_javascript(16, 0) = "array_m3h"
        set_variable_javascript(16, 1) = "["

        set_variable_javascript(17, 0) = "array_flow_mtr"
        ...
        For k = lunghezza_tabella - 1 To 0 Step -1
            Dim dc_log As ermes_web_20.quey_db.ld4_logRow
            ...
            set_variable_javascript(4, 1) = set_variable_javascript(4, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_soglia_1) + "]"
            set_variable_javascript(5, 1) = set_variable_javascript(5, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_soglia_2) + "]"
            set_variable_javascript(6, 1) = set_variable_javascript(6, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_soglia_3) + "]"
            set_variable_javascript(7, 1) = set_variable_javascript(7, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_soglia_4) + "]"

            set_variable_javascript(8, 1) = set_variable_javascript(8, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.dos_ch1) + "]"
            set_variable_javascript(9, 1) = set_variable_javascript(9, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.dos_ch2) + "]"

            set_variable_javascript(10, 1) = set_variable_javascript(10, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_probe_ch1) + "]"
            set_variable_javascript(11, 1) = set_variable_javascript(11, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.alarm_probe_ch2) + "]"


            set_variable_javascript(12, 1) = set_variable_javascript(12, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.livello_ch1) + "]"
            set_variable_javascript(13, 1) = set_variable_javascript(13, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.livello_ch2) + "]"


            set_variable_javascript(14, 1) = set_variable_javascript(14, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.flusso) + "]"
            set_variable_javascript(15, 1) = set_variable_javascript(15, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + Replace(dc_log.temperatura.ToString(), ",", ".") + "]"
            set_variable_javascript(16, 1) = set_variable_javascript(16, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + Replace(dc_log.flow_meter.ToString(), ",", ".") + "]"
            set_variable_javascript(17, 1) = set_variable_javascript(17, 1) + "[Date.UTC(" + dc_log.data.Year.ToString + "," + (dc_log.data.Month - 1).ToString + "," + dc_log.data.Day.ToString + "," + dc_log.data.Hour.ToString + "," + dc_log.data.Minute.ToString + ")," + get_status_boolean(dc_log.flow_mtr) + "]"
            index = index + 1
        ...
        literal_script.Text = literal_script.Text + "var ch1_feed_label='" + ch1_feed_label.Text + "';" + "var ch1_dos_label='" + ch1_dos_label.Text + "';" + "var ch1_probe_label='" + ch1_probe_label.Text + "';" + "var ch1_livello1_label='" + ch1_livello1_label.Text + "';"
        ...
        literal_script.Text = literal_script.Text + "var label_m3h='" + label_m3h.Text + "';"
    ...
    Protected Sub refresh_log_server_Click(sender As Object, e As EventArgs) Handles refresh_log_server.Click
        ...
        init_date = Page.Request("init_date")
        last_date = Page.Request("last_date")
        Response.Redirect("~/ld.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=43" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&init_date=" + init_date + "&last_date=" + last_date)
