Public Class modifica_impianto
    Inherits lingua

   
    Private Sub modifica_impianto_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
            ...
            For Each dc1 In lista_impianti
                ...
                If primo Then
                    ...
                    For Each dc2 In split_sub_impianto
                        ...
                        intestazione = intestazione + "<a href=""modifica_impianto_form.aspx?codice=" + split_sub_codice(i) + """ > "
