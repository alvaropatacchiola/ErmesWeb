Public Class setpoint_ch2
    ...
    Private Sub setpoint_ch2_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
    Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_setpoint_ch2_tower(nome_impianto, codice_impianto, id_485_impianto, canale, "Sepoint")
        End If
    End Sub
    Public Sub posiziona_setpoint_ch2_tower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, ByVal setpoint_traduzione As String)
        ...
        setpoint2_value = main_function.get_split_str(riga_strumento.value27)
        ...
        MTower_Type = main_function_config.get_tipo_strumento_tower(personalizzazione_aquacare, config_value(0), config_value(1), config_value(2), config_value(3), version_str, , fattore_divisione_temp _
                                                      , , , full_scale_temp, , , label_canale_temp, , etichettasetpoint)

        Dim value As Single = 0
        If MTower_Type = "Cd_pH_Cl" Or MTower_Type = "Cd_trc_Cl" Or MTower_Type = "Cd_trc_rH" Or MTower_Type = "Cd_pH_rH" Or MTower_Type = "Cd_pH" Then
            enable_working.Visible = False
        End If
        ...
        message_channel.Text = setpoint_traduzione + " Ch2 " + label_canale_temp
        Literal5.Text = etichettasetpoint
        Literal2.Text = Literal2.Text + etichettasetpoint
        Literal6.Text = etichettasetpoint
        Literal1.Text = Literal1.Text + etichettasetpoint
        Literal10.Text = etichettasetpoint
        Literal12.Text = etichettasetpoint
        If Val(Mid(setpoint2_value(0), 3, 1)) Then        'D1 On/Off
    ...
    Private Function MakeDataSetpoint() As String
        ...
        Return id_485_impianto + "setp2wMT" + Risultato + "setp2wend" & Chr(13)
    ...
    Protected Sub save_setpointtower_new_Click(sender As Object, e As EventArgs) Handles save_setpointtower_new.Click
        ...
        Response.Redirect("~/tower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=5" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
