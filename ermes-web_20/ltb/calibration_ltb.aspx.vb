Public Class calibration_ltb
    ...
    Public Sub posiziona_calibrationld(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, _
        ...
        save_calibration_newltb.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_calibration_newltb, ""))
    ...
    Protected Sub save_calibration_newltb_Click(sender As Object, e As EventArgs) Handles save_calibration_newltb.Click
        ...
        Response.Redirect("~/ltb.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=8&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
