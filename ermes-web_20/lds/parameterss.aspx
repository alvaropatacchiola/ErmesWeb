<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="parameterss.aspx.vb" Inherits="ermes_web_20.parameterss" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="lds/parameterss.aspx">
    <h3><asp:literal runat="server" text ="Parameters LDS" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
