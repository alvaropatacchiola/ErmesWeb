<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="max_strokes_2_magneti.aspx.vb" Inherits="ermes_web_20.max_strokes_2_magneti" %>
<form id="form" runat="server"  method="post" action="wd/max_strokes_2_magneti.aspx">
...
<div class="tabsbar tabsbar-2">
			<ul class="row-fluid row-merge">
               ...
               <li class="span2"><a id="tab_ld_sp4" href="#tab_ld_sp4_4" data-toggle="tab"><asp:literal text="mV Strokes" runat="server" ID="tabld1_4"></asp:literal></a></li>
...
<!-- tab 4 start-->
			<div class="tab-pane" id="tab_ld_sp4_4">
                ...
                <div class="row-fluid">
               	<div class="span3">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal35"  text="  " runat="server"></asp:literal></h5>
...
<div id ="disable_cl_pulse1">
                <div class="row-fluid">
               	<div class="span2">
                       <div id="riga1_cl_stk" class="control-group">
                           <div id="label1_cl_pulse1_proportional">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal39"  text=" " runat="server"></asp:literal></h5>
                           </div>
                           <div id="label1_cl_pulse1_on_off">
                                <h5 style="padding-top:10px"><asp:literal ID = "Literal40"  text="Strokes mV:" runat="server"></asp:literal></h5>
                           </div>
                       <asp:textbox ID="value1_cl_stk"  onblur="javascript: Changed_channel( 'value1_cl_stk','riga1_cl_stk',180, 1,0 );" class="span12"  runat="server" ></asp:textbox>
                </div>
                       </div>

                    <div class="span2">
                       <div id="riga2_cl_pulse1_1" class="control-group">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal41"  text=" " runat="server"></asp:literal></h5>
                </div>
                       </div>
                </div>
                 <!-- fine riga -->
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal42"  text=" " runat="server"></asp:literal></h5>
                               </div>
                           <div id="label2_cl_pulse1_on_off">
              <h5 style="padding-top:10px"><asp:literal ID = "Literal43"  text=" " runat="server"></asp:literal></h5>
                               </div>
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal44"  text="  " runat="server"></asp:literal></h5>
                </div>
                       </div>
                </div>
                 <!-- fine riga -->                                
<!-- riga -->
              ...
              <h5 style="padding-top:10px"><asp:literal ID = "Literal45"  text=" " runat="server"></asp:literal></h5>
                </div>
                       </div>
                </div>
                 <!-- fine riga -->  
...
<!-- tab 4 stop-->
                   ...
                   <b class="btn-primary btn-icon glyphicons ok"><asp:button runat="server" ID="save_maxstrokes2magneti_new" class="btn-primary" data-layout="center" data-type="confirm" data-toggle="notyfy" text="Salva e carica i dati" Font-Bold="True" /><i></i></b>

            </div>
        </div>
        </div>
<script type="text/javascript" src="wd/validator_max_strokes_2_magneti.js"></script>
