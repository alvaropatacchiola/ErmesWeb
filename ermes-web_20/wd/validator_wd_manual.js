...
$("#save_manual_newwd").click(function () {
    ...
    $('#save_manual_newwd').next('p').remove();
    ...
    if ((alarm_temp1) || (alarm_temp2) ||
        ...
        $('#save_manual_newwd').next('p').remove();
        $('#save_manual_newwd').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
