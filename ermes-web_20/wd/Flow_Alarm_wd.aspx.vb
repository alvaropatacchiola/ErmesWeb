Public Class WebForm5
    ...
    Private Sub flow_ld_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
     Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_flow_wd(nome_impianto, codice_impianto, id_485_impianto, canale, "mA Output", "Out Of Range Alarm", "Min/max High", "Min/max Low", "Time (min)")
        End If
    End Sub
    Public Sub posiziona_flow_wd(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String, _
        ...
        save_flowwd_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_flowwd_new, ""))
    ...
    Protected Sub save_flowwd_new_Click(sender As Object, e As EventArgs) Handles save_flowwd_new.Click
        ...
        Response.Redirect("~/wd.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=3" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
