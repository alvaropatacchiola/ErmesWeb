...
$("#save_setpointwd_EV_new").click(function () {
    ...
    $('#save_setpointwd_EV_new').next('p').remove();
    if (!($('#off_ph_pulse1').is(':checked'))) {
    ...
    if ((ph_pulse1_on) || (ph_pulse1_pm1) || (ph_pulse1_off) || (ph_pulse1_pm2) ||
           (ph_pulse1_speed) || (cl_pulse1_pm1) || (cl_pulse1_off) || (cl_pulse1_pm2) ||
           (cl_pulse1_speed) || (cl_relay_on) || (cl_relay_pm1) || (cl_relay_off) ||
           (cl_relay_pm2)) {
        $('#save_setpointwd_EV_new').next('p').remove();

        $('#save_setpointwd_EV_new').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
