...
$("#save_calibration_newltb").click(function () {
    ...
    $('#save_calibration_newltb').next('p').remove();
    ...
    if ((var_alarm_ch1_calibration) || (var_alarm_ch2_calibration)) {
        ...
        $('#save_calibration_newltb').next('p').remove();
        $('#save_calibration_newltb').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + '</span></p>');
        submit_status = false;
        error_general = false;
        return false;
    }
