<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="clock.aspx.vb" Inherits="ermes_web_20.clock" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>

<form id="form" runat="server" method="post" action="max5/clock.aspx">
    <h3><asp:literal runat="server" text ="Clock Setup Max5" ID="clock_channel" meta:resourcekey="clock_channelResource1"></asp:literal></h3>
    <div class="innerLR">
    ...
    <script type="text/javascript" src="max5/validator_max5_clock.js"></script>
