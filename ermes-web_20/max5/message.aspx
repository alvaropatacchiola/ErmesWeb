<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="message.aspx.vb" Inherits="ermes_web_20.message" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>


<form id="form" runat="server" method="post" action="max5/message.aspx">
    <h3><asp:literal runat="server" text ="Message Max 5" ID="message_channel" meta:resourcekey="message_channelResource1"></asp:literal></h3>
    <div class="innerLR">
...
<!-- tab 2 stop-->
    ...
    <script type="text/javascript" src="max5/validator_max5_message.js"></script>
