...
$("#save_message_newlta").click(function () {
    ...
    if ((var_mail1 == true) || (var_mail2 == true)) {
        ...
        $('#save_message_newlta').after('<p class="error help-block"><span class="label label-important">' + wrong_settings + ' </span></p>');
        submit_status = false;
        error_general = false;
        return false;
