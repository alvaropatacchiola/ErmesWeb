Public Class _option1
    ...
    Private Sub _option1_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
       Dim result As String = ""
        ...
        If Not IsPostBack Or result = "1" Then
            ...
            posiziona_option_tower(nome_impianto, codice_impianto, id_485_impianto, canale)
        End If
    End Sub
    Public Sub posiziona_option_tower(ByVal nome_impianto As String, codice_impianto As String, id_485_impianto As String, ByVal canale As String)
        ...
        save_optiontower_new.OnClientClick = String.Format("salva_dati(""{0}""); return false;", _
                    ClientScript.GetPostBackEventReference(save_optiontower_new, ""))
        ...
        If new_version = True Then
            alarm_out_enable.Visible = True
            If Val(Mid(option_value(0), 38, 1)) Then
                value_option_alarm_out.SelectedIndex = 0
            End If

            If Val(Mid(option_value(0), 39, 1)) Then
                value_option_alarm_out.SelectedIndex = 1
            End If
        Else
            alarm_out_enable.Visible = False
        End If
        ...
        If (MTower_Type = "Cd_Cl") Then
            ...
            value_option_Number_week.Text = Format(Val(Mid(option_value(0), 36, 2)), "0") ' Number Week
        End If
        If (MTower_Type = "Cd_pH_Cl") Or (MTower_Type = "Cd_trc_Cl") Or (MTower_Type = "Cd_rH_Cl") Then
            ch2_enable.Visible = True
    ...
    Private Function MakeDataOption() As String
        ...
        If (MTower_Type = "Cd_pH_rH") Or (MTower_Type = "Cd_pH_Cl") Or (MTower_Type = "Cd_trc_Cl") Then
            main_function_config.get_tipo_strumento_tower(personalizzazione_aquacare, config_value(0), config_value(1), config_value(2), config_value(3), version_str, , fattore_divisione_temp)
    ...
    Protected Sub save_optiontower_new_Click(sender As Object, e As EventArgs) Handles save_optiontower_new.Click
        ...
        Response.Redirect("~/tower.aspx?codice=" + codice_impianto + "&id_485=" + id_485_impianto + "&pagina=7" + "&nome_impianto=" + nome_impianto + "&statistica=" + statistica + "&" + url_result)
